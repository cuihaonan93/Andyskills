...
// ../mermaid/dist/chunks/mermaid.core/chunk-SVP7TREG.mjs
var diagramTitle = "";
var accTitle = "";
var accDescription = "";
var rules = [];
var ruleMap = /* @__PURE__ */ new Map();
var sanitizeText2 = /* @__PURE__ */ __name2((text) => {
  return sanitizeText(text, getConfig2());
}, "sanitizeText");
var sanitizeAstNode = /* @__PURE__ */ __name2((node) => {
  switch (node.type) {
    case "terminal":
...
var setTitle = /* @__PURE__ */ __name2((text) => {
  diagramTitle = sanitizeText2(text);
  log.debug("[Railroad] Title set:", text);
}, "setTitle");
var getTitle = /* @__PURE__ */ __name2(() => {
  return diagramTitle;
}, "getTitle");
var addRule = /* @__PURE__ */ __name2((rule) => {
  const sanitizedRule = {
    ...rule,
...
var getRules = /* @__PURE__ */ __name2(() => {
  return rules;
}, "getRules");
var getRule = /* @__PURE__ */ __name2((name) => {
  return ruleMap.get(name);
}, "getRule");
var setAccTitle = /* @__PURE__ */ __name2((text) => {
  accTitle = sanitizeText2(text).replace(/^\s+/g, "");
  log.debug("[Railroad] Accessibility title set:", text);
}, "setAccTitle");
var getAccTitle = /* @__PURE__ */ __name2(() => {
  return accTitle;
}, "getAccTitle");
var setAccDescription = /* @__PURE__ */ __name2((text) => {
  accDescription = sanitizeText2(text).replace(/\n\s+/g, "\n");
  log.debug("[Railroad] Accessibility description set:", text);
}, "setAccDescription");
var getAccDescription = /* @__PURE__ */ __name2(() => {
...
var isRailroadStyleOptions = /* @__PURE__ */ __name2((options) => {
  if (!options) {
    return false;
  }
...
var extractRailroadOverrides = /* @__PURE__ */ __name2((options) => {
  if (!options) {
    return {};
  }
...
var extractThemeOverrides = /* @__PURE__ */ __name2((options) => {
...
var sanitizeColorValue = /* @__PURE__ */ __name2((value, fallback) => {
...
var sanitizeFontFamilyValue = /* @__PURE__ */ __name2((value, fallback) => {
  if (typeof value !== "string") {
    return fallback;
  }
  const normalized = value.trim();
...
var sanitizeNumberValue = /* @__PURE__ */ __name2((value, fallback) => {
  const parsed = typeof value === "number" ? value : typeof value === "string" ? Number.parseFloat(value) : Number.NaN;
  return Number.isFinite(parsed) && parsed >= 0 ? parsed : fallback;
}, "sanitizeNumberValue");
var parseThemeFontSize = /* @__PURE__ */ __name2((value) => {
  const parsed = typeof value === "number" ? value : typeof value === "string" ? Number.parseFloat(value) : Number.NaN;
  return Number.isFinite(parsed) && parsed > 0 ? parsed : void 0;
}, "parseThemeFontSize");
var buildThemeDefaults = /* @__PURE__ */ __name2((themeVariables) => {
...
var buildRailroadStyleOptions = /* @__PURE__ */ __name2((options) => {
...
var configureRailroadSvgSize = /* @__PURE__ */ __name2((svg, dimensions, useMaxWidth) => {
  configureSvgSize(svg, dimensions.height, dimensions.width, useMaxWidth);
  svg.attr("viewBox", `0 0 ${dimensions.width} ${dimensions.height}`);
}, "configureRailroadSvgSize");
var draw = /* @__PURE__ */ __name2((text, id, _version) => {
