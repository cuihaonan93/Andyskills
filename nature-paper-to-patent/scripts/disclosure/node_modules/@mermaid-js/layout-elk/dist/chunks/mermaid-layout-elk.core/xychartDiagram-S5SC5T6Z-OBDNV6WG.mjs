...
// ../mermaid/dist/chunks/mermaid.core/xychartDiagram-S5SC5T6Z.mjs
...
var TextDimensionCalculatorWithFont = class {
  ...
  static {
    __name2(this, "TextDimensionCalculatorWithFont");
  }
...
__name2(getLegendLayout, "getLegendLayout");
...
__name2(getChartLegendComponent, "getChartLegendComponent");
var LinePlot = class {
  static {
...
var draw = /* @__PURE__ */ __name2((txt, id, _version, diagObj) => {
  const db = diagObj.db;
      ...
      case "rect":
        ...
        if (chartConfig.showDataLabel) {
          ...
          if (chartConfig.chartOrientation === "horizontal") {
            ...
            const determineLabelXPosition = /* @__PURE__ */ __name2((item) => {
            ...
            const uniformFontSize = Math.floor(Math.min(...candidateFontSizes));
            const determineLabelYPosition = /* @__PURE__ */ __name2((item) => {
              if (showDataLabelOutsideBar) {
