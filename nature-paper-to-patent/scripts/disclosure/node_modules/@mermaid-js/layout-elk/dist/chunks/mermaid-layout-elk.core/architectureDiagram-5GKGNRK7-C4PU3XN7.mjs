...
// ../mermaid/dist/chunks/mermaid.core/architectureDiagram-5GKGNRK7.mjs
...
var ArchitectureDirectionArrow = {
  L: /* @__PURE__ */ __name2((scale) => `${scale},${scale / 2} 0,${scale} 0,0`, "L"),
  R: /* @__PURE__ */ __name2((scale) => `0,${scale / 2} ${scale},0 ${scale},${scale}`, "R"),
  T: /* @__PURE__ */ __name2((scale) => `0,0 ${scale},0 ${scale / 2},${scale}`, "T"),
  B: /* @__PURE__ */ __name2((scale) => `${scale / 2},0 ${scale},${scale} 0,${scale}`, "B")
};
var ArchitectureDirectionArrowShift = {
  L: /* @__PURE__ */ __name2((orig, arrowSize) => orig - arrowSize + 2, "L"),
  R: /* @__PURE__ */ __name2((orig, _arrowSize) => orig - 2, "R"),
  T: /* @__PURE__ */ __name2((orig, arrowSize) => orig - arrowSize + 2, "T"),
  B: /* @__PURE__ */ __name2((orig, _arrowSize) => orig - 2, "B")
};
var getOppositeArchitectureDirection = /* @__PURE__ */ __name2(function(x) {
...
var isArchitectureDirection = /* @__PURE__ */ __name2(function(x) {
  const temp = x;
  return temp === "L" || temp === "R" || temp === "T" || temp === "B";
}, "isArchitectureDirection");
var isArchitectureDirectionX = /* @__PURE__ */ __name2(function(x) {
  const temp = x;
  return temp === "L" || temp === "R";
}, "isArchitectureDirectionX");
var isArchitectureDirectionY = /* @__PURE__ */ __name2(function(x) {
  const temp = x;
  return temp === "T" || temp === "B";
}, "isArchitectureDirectionY");
var isArchitectureDirectionXY = /* @__PURE__ */ __name2(function(a, b) {
  const aX_bY = isArchitectureDirectionX(a) && isArchitectureDirectionY(b);
  const aY_bX = isArchitectureDirectionY(a) && isArchitectureDirectionX(b);
  return aX_bY || aY_bX;
}, "isArchitectureDirectionXY");
var isArchitecturePairXY = /* @__PURE__ */ __name2(function(pair) {
  const lhs = pair[0];
  const rhs = pair[1];
...
var isValidArchitectureDirectionPair = /* @__PURE__ */ __name2(function(x) {
  return x !== "LL" && x !== "RR" && x !== "TT" && x !== "BB";
}, "isValidArchitectureDirectionPair");
var getArchitectureDirectionPair = /* @__PURE__ */ __name2(function(sourceDir, targetDir) {
  const pair = `${sourceDir}${targetDir}`;
  return isValidArchitectureDirectionPair(pair) ? pair : void 0;
}, "getArchitectureDirectionPair");
var shiftPositionByArchitectureDirectionPair = /* @__PURE__ */ __name2(function([x, y], pair) {
  const lhs = pair[0];
  const rhs = pair[1];
...
var getArchitectureDirectionXYFactors = /* @__PURE__ */ __name2(function(pair) {
  if (pair === "LT" || pair === "TL") {
    return [1, 1];
...
var getArchitectureDirectionAlignment = /* @__PURE__ */ __name2(function(a, b) {
...
var isArchitectureService = /* @__PURE__ */ __name2(function(x) {
  const temp = x;
  return temp.type === "service";
}, "isArchitectureService");
var isArchitectureJunction = /* @__PURE__ */ __name2(function(x) {
  const temp = x;
  return temp.type === "junction";
}, "isArchitectureJunction");
var architectureGroupAlignmentKey = /* @__PURE__ */ __name2((groupA, groupB) => {
...
var edgeData = /* @__PURE__ */ __name2((edge) => {
  return edge.data();
}, "edgeData");
var nodeData = /* @__PURE__ */ __name2((node) => {
  return node.data();
}, "nodeData");
...
var ArchitectureDB = class {
  ...
  getDataStructures() {
    if (this.dataStructures === void 0) {
      ...
      const BFS = /* @__PURE__ */ __name2((startingId) => {
...
var populateDb = /* @__PURE__ */ __name2((ast, db) => {
...
__name2(withSeededRandom, "withSeededRandom");
var wrapIcon = /* @__PURE__ */ __name2((icon) => {
...
var drawEdges = /* @__PURE__ */ __name2(async function(edgesEl, cy, db, diagramId) {
...
var drawGroups = /* @__PURE__ */ __name2(async function(groupsEl, cy, db, diagramId) {
  const padding = db.getConfigField("padding");
...
var drawServices = /* @__PURE__ */ __name2(async function(db, elem, services, diagramId) {
...
var drawJunctions = /* @__PURE__ */ __name2(function(db, elem, junctions, diagramId) {
...
function getAlignments(db, spatialMaps, groupAlignments, layoutHints = []) {
  const flattenAlignments = /* @__PURE__ */ __name2((alignmentMap, alignmentDir) => {
  ...
  const dropOverlapping = /* @__PURE__ */ __name2((groups) => groups.filter((group) => !group.some((id) => declaredMembers.has(id))), "dropOverlapping");
...
function getRelativeConstraints(spatialMaps, db, layoutHints = []) {
  ...
  const posToStr = /* @__PURE__ */ __name2((pos) => `${pos[0]},${pos[1]}`, "posToStr");
  const strToPos = /* @__PURE__ */ __name2((pos) => pos.split(",").map((p) => parseInt(p)), "strToPos");
...
var draw = /* @__PURE__ */ __name2(async (text, id, _version, diagObj) => {
  const db = diagObj.db;
  db.setDiagramId(id);
