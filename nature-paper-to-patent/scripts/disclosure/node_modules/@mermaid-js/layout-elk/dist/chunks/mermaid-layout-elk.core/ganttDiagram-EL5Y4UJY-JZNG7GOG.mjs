...
// ../mermaid/dist/chunks/mermaid.core/ganttDiagram-EL5Y4UJY.mjs
...
var setDiagramId = /* @__PURE__ */ __name2(function(id) {
  diagramId = id;
}, "setDiagramId");
var setAxisFormat = /* @__PURE__ */ __name2(function(txt) {
  axisFormat = txt;
}, "setAxisFormat");
var getAxisFormat = /* @__PURE__ */ __name2(function() {
  return axisFormat;
}, "getAxisFormat");
var setTickInterval = /* @__PURE__ */ __name2(function(txt) {
  tickInterval = txt;
}, "setTickInterval");
var getTickInterval = /* @__PURE__ */ __name2(function() {
  return tickInterval;
}, "getTickInterval");
var setTodayMarker = /* @__PURE__ */ __name2(function(txt) {
  todayMarker = txt;
}, "setTodayMarker");
var getTodayMarker = /* @__PURE__ */ __name2(function() {
  return todayMarker;
}, "getTodayMarker");
var setDateFormat = /* @__PURE__ */ __name2(function(txt) {
  dateFormat = txt;
}, "setDateFormat");
var enableInclusiveEndDates = /* @__PURE__ */ __name2(function() {
  inclusiveEndDates = true;
}, "enableInclusiveEndDates");
var endDatesAreInclusive = /* @__PURE__ */ __name2(function() {
  return inclusiveEndDates;
}, "endDatesAreInclusive");
var enableTopAxis = /* @__PURE__ */ __name2(function() {
  topAxis = true;
}, "enableTopAxis");
var topAxisEnabled = /* @__PURE__ */ __name2(function() {
  return topAxis;
}, "topAxisEnabled");
var setDisplayMode = /* @__PURE__ */ __name2(function(txt) {
  displayMode = txt;
}, "setDisplayMode");
var getDisplayMode = /* @__PURE__ */ __name2(function() {
  return displayMode;
}, "getDisplayMode");
var getDateFormat = /* @__PURE__ */ __name2(function() {
  return dateFormat;
}, "getDateFormat");
var mergeTokens = /* @__PURE__ */ __name2((existing, txt) => {
  const tokens = txt.toLowerCase().split(/[\s,]+/).filter((t) => t !== "");
  return [.../* @__PURE__ */ new Set([...existing, ...tokens])];
}, "mergeTokens");
var setIncludes = /* @__PURE__ */ __name2(function(txt) {
  includes = mergeTokens(includes, txt);
}, "setIncludes");
var getIncludes = /* @__PURE__ */ __name2(function() {
  return includes;
}, "getIncludes");
var setExcludes = /* @__PURE__ */ __name2(function(txt) {
  excludes = mergeTokens(excludes, txt);
}, "setExcludes");
var getExcludes = /* @__PURE__ */ __name2(function() {
  return excludes;
}, "getExcludes");
var getLinks = /* @__PURE__ */ __name2(function() {
  return links;
}, "getLinks");
var addSection = /* @__PURE__ */ __name2(function(txt) {
  currentSection = txt;
  sections.push(txt);
}, "addSection");
var getSections = /* @__PURE__ */ __name2(function() {
  return sections;
}, "getSections");
var getTasks = /* @__PURE__ */ __name2(function() {
...
var isInvalidDate = /* @__PURE__ */ __name2(function(date, dateFormat2, excludes2, includes2) {
...
var setWeekday = /* @__PURE__ */ __name2(function(txt) {
  weekday = txt;
}, "setWeekday");
var getWeekday = /* @__PURE__ */ __name2(function() {
  return weekday;
}, "getWeekday");
var setWeekend = /* @__PURE__ */ __name2(function(startDay) {
  weekend = startDay;
}, "setWeekend");
var checkTaskDates = /* @__PURE__ */ __name2(function(task, dateFormat2, excludes2, includes2) {
...
var fixTaskDates = /* @__PURE__ */ __name2(function(startTime, endTime, dateFormat2, excludes2, includes2) {
  let invalid = false;
...
var getStartDate = /* @__PURE__ */ __name2(function(prevTime, dateFormat2, str) {
  str = str.trim();
  const isTimestampFormat = /* @__PURE__ */ __name2((format) => {
...
var parseDuration = /* @__PURE__ */ __name2(function(str) {
...
var getEndDate = /* @__PURE__ */ __name2(function(prevTime, dateFormat2, str, inclusive = false) {
  str = str.trim();
...
var taskCnt = 0;
var parseId = /* @__PURE__ */ __name2(function(idStr) {
  if (idStr === void 0) {
    taskCnt = taskCnt + 1;
    return "task" + taskCnt;
  }
...
var compileData = /* @__PURE__ */ __name2(function(prevTask, dataStr) {
  let ds;
...
var parseData = /* @__PURE__ */ __name2(function(prevTaskId, dataStr) {
  let ds;
  if (dataStr.substr(0, 1) === ":") {
    ds = dataStr.substr(1, dataStr.length);
  } else {
...
var rawTasks = [];
var taskDb = {};
var addTask = /* @__PURE__ */ __name2(function(descr, data) {
  const rawTask = {
...
var findTaskById = /* @__PURE__ */ __name2(function(id) {
  const pos = taskDb[id];
  return rawTasks[pos];
}, "findTaskById");
var addTaskOrg = /* @__PURE__ */ __name2(function(descr, data) {
  const newTask = {
    section: currentSection,
    type: currentSection,
    description: descr,
...
var compileTasks = /* @__PURE__ */ __name2(function() {
  const compileTask = /* @__PURE__ */ __name2(function(pos) {
...
var setLink = /* @__PURE__ */ __name2(function(ids, _linkStr) {
...
var setClass = /* @__PURE__ */ __name2(function(ids, className) {
  ids.split(",").forEach(function(id) {
    let rawTask = findTaskById(id);
    if (rawTask !== void 0) {
...
var setClickFun = /* @__PURE__ */ __name2(function(id, functionName, functionArgs) {
  if (getConfig2().securityLevel !== "loose") {
    return;
  }
...
var pushFun = /* @__PURE__ */ __name2(function(id, callbackFunction) {
  funs.push(
    function() {
...
var setClickEvent = /* @__PURE__ */ __name2(function(ids, functionName, functionArgs) {
  ids.split(",").forEach(function(id) {
    setClickFun(id, functionName, functionArgs);
  });
  setClass(ids, "clickable");
}, "setClickEvent");
var bindFunctions = /* @__PURE__ */ __name2(function(element) {
  funs.forEach(function(fun) {
    fun(element);
  });
}, "bindFunctions");
var ganttDb_default = {
  getConfig: /* @__PURE__ */ __name2(() => getConfig2().gantt, "getConfig"),
  clear: clear2,
  setDateFormat,
  getDateFormat,
  enableInclusiveEndDates,
...
var setConf = /* @__PURE__ */ __name2(function() {
...
var getMaxIntersections = /* @__PURE__ */ __name2((tasks2, orderOffset) => {
...
var draw = /* @__PURE__ */ __name2(function(text, id, version, diagObj) {
  ...
  __name2(getEstimatedTickCount, "getEstimatedTickCount");
