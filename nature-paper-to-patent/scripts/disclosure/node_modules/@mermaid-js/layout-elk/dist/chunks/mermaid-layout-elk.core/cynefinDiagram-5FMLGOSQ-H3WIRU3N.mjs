...
// ../mermaid/dist/chunks/mermaid.core/cynefinDiagram-5FMLGOSQ.mjs
var createDefaultData = /* @__PURE__ */ __name2(() => ({
  domains: /* @__PURE__ */ new Map(),
  transitions: []
}), "createDefaultData");
var data = createDefaultData();
var getDomains = /* @__PURE__ */ __name2(() => data.domains, "getDomains");
var getTransitions = /* @__PURE__ */ __name2(() => data.transitions, "getTransitions");
var setDomains = /* @__PURE__ */ __name2((blocks) => {
  if (!blocks) {
    return;
  }
...
var setTransitions = /* @__PURE__ */ __name2((transitions) => {
  if (!transitions) {
    return;
  }
...
__name2(resolveSeed, "resolveSeed");
...
__name2(generateFoldPath, "generateFoldPath");
...
__name2(generateHorizontalBoundary, "generateHorizontalBoundary");
...
__name2(generateCliffPath, "generateCliffPath");
...
__name2(generateConfusionPath, "generateConfusionPath");
var DOMAIN_META = {
...
var getDomainLayouts = /* @__PURE__ */ __name2((width, height) => {
  const hw = width / 2;
  const hh = height / 2;
  return {
...
var getCynefinDomainColors = /* @__PURE__ */ __name2(() => {
...
var renderer = { draw };
var getCynefinTheme = /* @__PURE__ */ __name2(() => {
  const defaultThemeVariables = getThemeVariables3();
  const currentConfig = getConfig();
  const themeVariables = cleanAndMerge(defaultThemeVariables, currentConfig.themeVariables);
  return themeVariables.cynefin;
