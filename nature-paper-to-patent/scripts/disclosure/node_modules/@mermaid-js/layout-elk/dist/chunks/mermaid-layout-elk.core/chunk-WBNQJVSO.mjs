import {
  at
} from "./chunk-MI2JWT3U.mjs";
import {
  compileStyles,
  solidStateFill,
  styles2String,
  userNodeOverrides
} from "./chunk-LRUWYD7V.mjs";
import {
  createText,
  fastdom_default
...
// ../mermaid/dist/chunks/mermaid.core/chunk-TEH6E4GO.mjs
...
__name2(configureLabelImages, "configureLabelImages");
...
__name2(hasTextBesidesImages, "hasTextBesidesImages");
var SECTION_GAP = 3;
var MIN_WRAP_WIDTH = 32;
var c4LabelHelper = /* @__PURE__ */ __name2(async (parent, node, classes) => {
...
var labelHelper = /* @__PURE__ */ __name2(async (parent, node, _classes) => {
...
var insertLabel = /* @__PURE__ */ __name2(async (parent, label, options) => {
...
var updateNodeBounds = /* @__PURE__ */ __name2((node, element, knownBounds) => {
  if (knownBounds) {
...
var getNodeClasses = /* @__PURE__ */ __name2((node, extra) => (node.look === "handDrawn" ? "rough-node" : "node") + " " + node.cssClasses + " " + (extra || ""), "getNodeClasses");
...
function mergePaths(roughElement) {
  ...
  const getAttr = /* @__PURE__ */ __name2((element, attr) => {
...
__name2(mergePaths, "mergePaths");
var intersectRect = /* @__PURE__ */ __name2((node, point) => {
  var x = node.x;
  var y = node.y;
  var dx = point.x - x;
  var dy = point.y - y;
...
var createRoundedRectPathD = /* @__PURE__ */ __name2((x, y, totalWidth, totalHeight, radius) => [
  "M",
  x + radius,
  y,
...
var createLabel = /* @__PURE__ */ __name2(async (element, _vertexText, style, isTitle = false, isNode = false) => {
...
__name2(calculateArcSagitta, "calculateArcSagitta");
async function bowTieRect(parent, node) {
  ...
  const calcTotalHeight = /* @__PURE__ */ __name2((labelHeight) => labelHeight + labelPaddingY, "calcTotalHeight");
  const calcEllipseRadius = /* @__PURE__ */ __name2((totalHeight2) => {
...
async function bucket(parent, node, { config: { themeVariables } }) {
  ...
  const arc = /* @__PURE__ */ __name2((rx, cy, ySign) => Array.from({ length: ARC_SEGMENTS + 1 }, (_, i) => {
...
__name2(collapsedGroup, "collapsedGroup");
...
var POINT_KEY = "point";
var expandAndDeduplicateDirections = /* @__PURE__ */ __name2((directions) => {
...
var getDirectionKey = /* @__PURE__ */ __name2((directions) => DIRECTION_ORDER.filter((direction) => directions.has(direction)).join("|") || POINT_KEY, "getDirectionKey");
var arrowPointFactories = {
  "right|left|up|down": /* @__PURE__ */ __name2(({ height, midpoint, padding, width }) => [
    { x: 0, y: 0 },
    { x: midpoint, y: 0 },
  ...
  "right|left|up": /* @__PURE__ */ __name2(({ height, midpoint, width }) => [
    { x: midpoint, y: 0 },
    { x: width - midpoint, y: 0 },
    { x: width, y: -height / 2 },
    { x: width - midpoint, y: -height },
  ...
  "right|left|down": /* @__PURE__ */ __name2(({ height, midpoint, width }) => [
    { x: 0, y: 0 },
    { x: midpoint, y: -height },
    { x: width - midpoint, y: -height },
    { x: width, y: 0 }
  ], "right|left|down"),
  "right|up|down": /* @__PURE__ */ __name2(({ height, midpoint, width }) => [
    { x: 0, y: 0 },
    { x: width, y: -midpoint },
    { x: width, y: -height + midpoint },
    { x: 0, y: -height }
  ], "right|up|down"),
  "left|up|down": /* @__PURE__ */ __name2(({ height, midpoint, width }) => [
    { x: width, y: 0 },
    { x: 0, y: -midpoint },
    { x: 0, y: -height + midpoint },
    { x: width, y: -height }
  ], "left|up|down"),
  "right|left": /* @__PURE__ */ __name2(({ height, midpoint, padding, width }) => [
    { x: midpoint, y: 0 },
  ...
  "up|down": /* @__PURE__ */ __name2(({ height, midpoint, padding, width }) => [
    { x: width / 2, y: 0 },
    { x: 0, y: -padding },
    { x: midpoint, y: -padding },
    { x: midpoint, y: -height + padding },
  ...
  "right|up": /* @__PURE__ */ __name2(({ height, midpoint, width }) => [
    { x: 0, y: 0 },
    { x: width, y: -midpoint },
    { x: 0, y: -height }
  ], "right|up"),
  "right|down": /* @__PURE__ */ __name2(({ height, width }) => [
    { x: 0, y: 0 },
    { x: width, y: 0 },
    { x: 0, y: -height }
  ], "right|down"),
  "left|up": /* @__PURE__ */ __name2(({ height, midpoint, width }) => [
    { x: width, y: 0 },
    { x: 0, y: -midpoint },
    { x: width, y: -height }
  ], "left|up"),
  "left|down": /* @__PURE__ */ __name2(({ height, width }) => [
    { x: width, y: 0 },
    { x: 0, y: 0 },
    { x: width, y: -height }
  ], "left|down"),
  right: /* @__PURE__ */ __name2(({ height, midpoint, padding, width }) => [
    { x: midpoint, y: -padding },
    { x: midpoint, y: -padding },
    { x: width - midpoint, y: -padding },
    { x: width - midpoint, y: 0 },
  ...
  left: /* @__PURE__ */ __name2(({ height, midpoint, padding, width }) => [
    { x: midpoint, y: 0 },
    { x: midpoint, y: -padding },
    { x: width - midpoint, y: -padding },
    { x: width - midpoint, y: -height + padding },
  ...
  up: /* @__PURE__ */ __name2(({ height, midpoint, padding, width }) => [
    { x: midpoint, y: -padding },
    { x: midpoint, y: -height + padding },
    { x: 0, y: -height + padding },
    { x: width / 2, y: -height },
  ...
  down: /* @__PURE__ */ __name2(({ height, midpoint, padding, width }) => [
    { x: width / 2, y: 0 },
    { x: 0, y: -padding },
    { x: midpoint, y: -padding },
    { x: midpoint, y: -height + padding },
...
var getArrowPoints = /* @__PURE__ */ __name2((duplicatedDirections, bbox, node, totalWidth) => {
...
__name2(block_arrow, "block_arrow");
...
__name2(consoleWindow, "consoleWindow");
...
__name2(person, "person");
var createCylinderPathD = /* @__PURE__ */ __name2((x, y, width, height, rx, ry) => {
  return [
    `M${x},${y + ry}`,
...
var createOuterCylinderPathD = /* @__PURE__ */ __name2((x, y, width, height, rx, ry) => {
  return [
    `M${x},${y + ry}`,
    `M${x + width},${y + ry}`,
    `a${rx},${ry} 0,0,0 ${-width},0`,
...
var createInnerCylinderPathD = /* @__PURE__ */ __name2((x, y, width, height, rx, ry) => {
...
var createHexagonPathD = /* @__PURE__ */ __name2((x, y, width, height, m) => {
  return [
    `M${x + m},${y}`,
    `L${x + width - m},${y}`,
...
var createCylinderPathD2 = /* @__PURE__ */ __name2((x, y, width, height, rx, ry, outerOffset) => {
  return [
    `M${x},${y + ry}`,
    `a${rx},${ry} 0,0,0 ${width},0`,
    `a${rx},${ry} 0,0,0 ${-width},0`,
...
var createOuterCylinderPathD2 = /* @__PURE__ */ __name2((x, y, width, height, rx, ry, outerOffset) => {
  return [
    `M${x},${y + ry}`,
    `M${x + width},${y + ry}`,
    `a${rx},${ry} 0,0,0 ${-width},0`,
...
var createInnerCylinderPathD2 = /* @__PURE__ */ __name2((x, y, width, height, rx, ry) => {
  return [`M${x - width / 2},${-height / 2}`, `a${rx},${ry} 0,0,0 ${width},0`].join(" ");
}, "createInnerCylinderPathD");
var MIN_HEIGHT3 = 10;
var MIN_WIDTH4 = 10;
...
__name(note, "note");
__name2(note, "note");
var createDecisionBoxPathD = /* @__PURE__ */ __name2((x, y, size) => {
  return [
    `M${x + size / 2},${y}`,
    `L${x + size},${y - size / 2}`,
    `L${x + size / 2},${y - size}`,
...
__name(text, "text");
__name2(text, "text");
var createCylinderPathD3 = /* @__PURE__ */ __name2((x, y, width, height, rx, ry) => {
  return `M${x},${y}
...
var createOuterCylinderPathD3 = /* @__PURE__ */ __name2((x, y, width, height, rx, ry) => {
  return [
    `M${x},${y}`,
    `M${x + width},${y}`,
    `a${rx},${ry} 0,0,0 ${0},${-height}`,
...
var createInnerCylinderPathD3 = /* @__PURE__ */ __name2((x, y, width, height, rx, ry) => {
...
__name2(lineToPolygon, "lineToPolygon");
...
var colorFromPriority = /* @__PURE__ */ __name2((priority) => {
  switch (priority) {
    case "Very High":
      return "red";
    case "High":
...
var generateShapeMap = /* @__PURE__ */ __name2(() => {
