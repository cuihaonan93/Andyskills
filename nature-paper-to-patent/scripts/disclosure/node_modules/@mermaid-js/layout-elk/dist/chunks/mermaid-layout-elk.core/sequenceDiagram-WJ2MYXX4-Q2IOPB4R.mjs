...
// ../mermaid/dist/chunks/mermaid.core/sequenceDiagram-WJ2MYXX4.mjs
var import_sanitize_url = __toESM(require_dist(), 1);
import { select } from "d3";
var parser = (function() {
  var o = /* @__PURE__ */ __name2(function(k, v, o2, l) {
  ...
  var parser2 = {
    trace: /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function trace() {
    }, "trace"), "trace"),
    yy: {},
    ...
    performAction: /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function anonymous(yytext, yyleng, yylineno, yy, yystate, $$, _$) {
      var $0 = $$.length - 1;
      switch (yystate) {
        case 3:
          yy.apply($$[$0]);
    ...
    parseError: /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function parseError(str, hash) {
      if (hash.recoverable) {
        this.trace(str);
      } else {
    ...
    parse: /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function parse(input) {
  ...
  var lexer = /* @__PURE__ */ (function() {
    var lexer2 = {
      ...
      setInput: /* @__PURE__ */ __name2(function(input, yy) {
        this.yy = yy || this.yy || {};
        this._input = input;
      ...
      unput: /* @__PURE__ */ __name2(function(ch) {
        var len = ch.length;
        var lines = ch.split(/(?:\r\n?|\n)/g);
      ...
      more: /* @__PURE__ */ __name2(function() {
        this._more = true;
        return this;
      }, "more"),
      // When called from action, signals the lexer that this rule fails to match the input, so the next matching rule (regex) should be tested instead.
      reject: /* @__PURE__ */ __name2(function() {
      ...
      less: /* @__PURE__ */ __name2(function(n) {
        this.unput(this.match.slice(n));
      }, "less"),
      // displays already matched input, i.e. for error messages
      pastInput: /* @__PURE__ */ __name2(function() {
        var past = this.matched.substr(0, this.matched.length - this.match.length);
        return (past.length > 20 ? "..." : "") + past.substr(-20).replace(/\n/g, "");
      }, "pastInput"),
      // displays upcoming input, i.e. for error messages
      upcomingInput: /* @__PURE__ */ __name2(function() {
        var next = this.match;
        if (next.length < 20) {
      ...
      showPosition: /* @__PURE__ */ __name2(function() {
        var pre = this.pastInput();
        var c = new Array(pre.length + 1).join("-");
        return pre + this.upcomingInput() + "\n" + c + "^";
      }, "showPosition"),
      // test the lexed token: return FALSE when not a match, otherwise return token
      test_match: /* @__PURE__ */ __name2(function(match, indexed_rule) {
      ...
      lex: /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function lex() {
        var r = this.next();
        if (r) {
          return r;
        } else {
      ...
      begin: /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function begin(condition) {
        this.conditionStack.push(condition);
      }, "begin"), "begin"),
      // pop the previously active lexer condition state off the condition stack
      popState: /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function popState() {
      ...
      _currentRules: /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function _currentRules() {
      ...
      topState: /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function topState(n) {
      ...
      pushState: /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function pushState(condition) {
        this.begin(condition);
      }, "pushState"), "pushState"),
      // return the number of states currently on the stack
      stateStackSize: /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function stateStackSize() {
        return this.conditionStack.length;
      }, "stateStackSize"), "stateStackSize"),
      options: { "case-insensitive": true },
      performAction: /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function anonymous(yy, yy_, $avoiding_name_collisions, YY_START) {
...
var getStyles = /* @__PURE__ */ __name2((options) => {
...
var drawRect2 = /* @__PURE__ */ __name2(function(elem, rectData) {
...
var drawPopup = /* @__PURE__ */ __name2(function(elem, actor, minMenuWidth, textAttrs, forceMenus) {
...
var popupMenuToggle = /* @__PURE__ */ __name2(function(popId) {
  return "var pu = document.getElementById('" + popId + "'); if (pu != null) { pu.style.display = pu.style.display == 'block' ? 'none' : 'block'; }";
}, "popupMenuToggle");
var drawKatex = /* @__PURE__ */ __name2(async function(elem, textData, msgModel = null) {
...
var drawText = /* @__PURE__ */ __name2(function(elem, textData) {
  ...
  let textElems = [];
  let dy = 0;
  let yfunc = /* @__PURE__ */ __name2(() => textData.y, "yfunc");
  if (textData.valign !== void 0 && textData.textMargin !== void 0 && textData.textMargin > 0) {
    switch (textData.valign) {
      case "top":
      case "start":
        yfunc = /* @__PURE__ */ __name2(() => Math.round(textData.y + textData.textMargin), "yfunc");
        break;
      case "middle":
      case "center":
        yfunc = /* @__PURE__ */ __name2(() => Math.round(textData.y + (prevTextHeight + textHeight + textData.textMargin) / 2), "yfunc");
        break;
      case "bottom":
      case "end":
        yfunc = /* @__PURE__ */ __name2(() => Math.round(
...
var drawLabel = /* @__PURE__ */ __name2(function(elem, txtObject) {
...
var actorCnt = -1;
var fixLifeLineHeights = /* @__PURE__ */ __name2((diagram2, actors, actorKeys, conf2) => {
  if (!diagram2.select) {
    return;
  }
...
var drawActorTypeParticipant = /* @__PURE__ */ __name2(function(elem, actor, conf2, isFooter, actorIndexMap) {
...
var drawActorTypeCollections = /* @__PURE__ */ __name2(function(elem, actor, conf2, isFooter, actorIndexMap) {
  const actorY = isFooter ? actor.stopy : actor.starty;
  const center = actor.x + actor.width / 2;
  const centerY = actorY + actor.height;
  const { look, theme, themeVariables } = conf2;
...
var drawActorTypeQueue = /* @__PURE__ */ __name2(function(elem, actor, conf2, isFooter, actorIndexMap) {
  const actorY = isFooter ? actor.stopy : actor.starty;
  const center = actor.x + actor.width / 2;
  const centerY = actorY + actor.height;
  const { look, theme, themeVariables } = conf2;
...
var drawActorTypeControl = /* @__PURE__ */ __name2(function(elem, actor, conf2, isFooter, diagramId, actorIndexMap) {
  const actorY = isFooter ? actor.stopy : actor.starty;
  const center = actor.x + actor.width / 2;
...
var drawActorTypeEntity = /* @__PURE__ */ __name2(function(elem, actor, conf2, isFooter, actorIndexMap) {
  const actorY = isFooter ? actor.stopy : actor.starty;
  const center = actor.x + actor.width / 2;
  const centerY = actorY + 75;
  const { look, theme, themeVariables } = conf2;
...
var drawActorTypeDatabase = /* @__PURE__ */ __name2(function(elem, actor, conf2, isFooter, actorIndexMap) {
  const actorY = isFooter ? actor.stopy : actor.starty;
  const center = actor.x + actor.width / 2;
...
var drawActorTypeBoundary = /* @__PURE__ */ __name2(function(elem, actor, conf2, isFooter, actorIndexMap) {
  const actorY = isFooter ? actor.stopy : actor.starty;
  const center = actor.x + actor.width / 2;
...
var drawActorTypeActor = /* @__PURE__ */ __name2(function(elem, actor, conf2, isFooter, actorIndexMap) {
  const actorY = isFooter ? actor.stopy : actor.starty;
  const center = actor.x + actor.width / 2;
  const centerY = actorY + 80;
  const { look, theme, themeVariables } = conf2;
...
var drawActor = /* @__PURE__ */ __name2(async function(elem, actor, conf2, isFooter, diagramId, diagObj, actorIndexMap) {
...
var drawBox = /* @__PURE__ */ __name2(function(elem, box, conf2) {
...
var anchorElement = /* @__PURE__ */ __name2(function(elem) {
  return elem.append("g");
}, "anchorElement");
var drawActivation = /* @__PURE__ */ __name2(function(_elem, bounds2, verticalPos, conf2, actorActivations2, diagObj, actorIndexMap) {
...
var drawLoop = /* @__PURE__ */ __name2(async function(elem, loopModel, labelText, conf2, msg) {
  const {
    boxMargin,
    boxTextMargin,
    labelBoxHeight,
  ...
  const drawLoopLine = /* @__PURE__ */ __name2(function(startx, starty, stopx, stopy) {
...
var drawBackgroundRect2 = /* @__PURE__ */ __name2(function(elem, bounds2) {
  drawBackgroundRect(elem, bounds2);
}, "drawBackgroundRect");
var insertDatabaseIcon = /* @__PURE__ */ __name2(function(elem, id) {
...
var insertComputerIcon = /* @__PURE__ */ __name2(function(elem, id) {
...
var insertClockIcon = /* @__PURE__ */ __name2(function(elem, id) {
...
var insertArrowHead = /* @__PURE__ */ __name2(function(elem, id) {
...
var insertArrowFilledHead = /* @__PURE__ */ __name2(function(elem, id) {
...
var insertSequenceNumber = /* @__PURE__ */ __name2(function(elem, id) {
...
var insertArrowCrossHead = /* @__PURE__ */ __name2(function(elem, id) {
...
var insertDropShadow = /* @__PURE__ */ __name2(function(elem, conf2) {
  const { theme } = conf2;
...
var getTextObj2 = /* @__PURE__ */ __name2(function() {
  return {
    x: 0,
    y: 0,
    fill: void 0,
...
var getNoteRect2 = /* @__PURE__ */ __name2(function() {
  return {
    x: 0,
    y: 0,
    fill: "#EDF2AE",
...
var insertSolidTopArrowHead = /* @__PURE__ */ __name2(function(elem, id) {
...
var insertSolidBottomArrowHead = /* @__PURE__ */ __name2(function(elem, id) {
...
var insertStickTopArrowHead = /* @__PURE__ */ __name2(function(elem, id) {
...
var insertStickBottomArrowHead = /* @__PURE__ */ __name2(function(elem, id) {
...
var bounds = {
  ...
  activations: [],
  models: {
    getHeight: /* @__PURE__ */ __name2(function() {
    ...
    addBox: /* @__PURE__ */ __name2(function(boxModel) {
      this.boxes.push(boxModel);
    }, "addBox"),
    addActor: /* @__PURE__ */ __name2(function(actorModel) {
      this.actors.push(actorModel);
    }, "addActor"),
    addLoop: /* @__PURE__ */ __name2(function(loopModel) {
      this.loops.push(loopModel);
    }, "addLoop"),
    addMessage: /* @__PURE__ */ __name2(function(msgModel) {
      this.messages.push(msgModel);
    }, "addMessage"),
    addNote: /* @__PURE__ */ __name2(function(noteModel) {
      this.notes.push(noteModel);
    }, "addNote"),
    lastActor: /* @__PURE__ */ __name2(function() {
      return this.actors[this.actors.length - 1];
    }, "lastActor"),
    lastLoop: /* @__PURE__ */ __name2(function() {
      return this.loops[this.loops.length - 1];
    }, "lastLoop"),
    lastMessage: /* @__PURE__ */ __name2(function() {
      return this.messages[this.messages.length - 1];
    }, "lastMessage"),
    lastNote: /* @__PURE__ */ __name2(function() {
  ...
  updateVal: /* @__PURE__ */ __name2(function(obj, key, val, fun) {
    if (obj[key] === void 0) {
      obj[key] = val;
    } else {
  ...
  updateBounds: /* @__PURE__ */ __name2(function(startx, starty, stopx, stopy) {
    const _self = this;
    let cnt = 0;
    function updateFn(type) {
      return /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function updateItemBounds(item) {
        cnt++;
  ...
  insert: /* @__PURE__ */ __name2(function(startx, starty, stopx, stopy) {
  ...
  newActivation: /* @__PURE__ */ __name2(function(message, diagram2, actors) {
  ...
  endActivation: /* @__PURE__ */ __name2(function(message) {
    const lastActorActivationIdx = this.activations.map(function(activation) {
      return activation.actor;
    }).lastIndexOf(message.from);
    return this.activations.splice(lastActorActivationIdx, 1)[0];
  }, "endActivation"),
  createLoop: /* @__PURE__ */ __name2(function(title = { message: void 0, wrap: false, width: void 0 }, fill) {
    return {
      startx: void 0,
  ...
  newLoop: /* @__PURE__ */ __name2(function(title = { message: void 0, wrap: false, width: void 0 }, fill) {
    this.sequenceItems.push(this.createLoop(title, fill));
  }, "newLoop"),
  endLoop: /* @__PURE__ */ __name2(function() {
    return this.sequenceItems.pop();
  }, "endLoop"),
  isLoopOverlap: /* @__PURE__ */ __name2(function() {
    return this.sequenceItems.length ? this.sequenceItems[this.sequenceItems.length - 1].overlap : false;
  }, "isLoopOverlap"),
  addSectionToLoop: /* @__PURE__ */ __name2(function(message) {
  ...
  saveVerticalPos: /* @__PURE__ */ __name2(function() {
    if (this.isLoopOverlap()) {
      this.savedVerticalPos = this.verticalPos;
    }
  }, "saveVerticalPos"),
  resetVerticalPos: /* @__PURE__ */ __name2(function() {
    if (this.isLoopOverlap()) {
      this.verticalPos = this.savedVerticalPos;
    }
  }, "resetVerticalPos"),
  bumpVerticalPos: /* @__PURE__ */ __name2(function(bump) {
    this.verticalPos = this.verticalPos + bump;
    this.data.stopy = common_default.getMax(this.data.stopy, this.verticalPos);
  }, "bumpVerticalPos"),
  getVerticalPos: /* @__PURE__ */ __name2(function() {
    return this.verticalPos;
  }, "getVerticalPos"),
  getBounds: /* @__PURE__ */ __name2(function() {
    return { bounds: this.data, models: this.models };
  }, "getBounds")
};
var drawNote = /* @__PURE__ */ __name2(async function(elem, noteModel, id) {
...
var drawCentralConnection = /* @__PURE__ */ __name2(function(elem, msg, msgModel, diagObj, startx, stopx, lineStartY) {
  ...
  const getCircleOffset = /* @__PURE__ */ __name2((isLeftToRight2, isReverse2) => {
  ...
  const drawCircle = /* @__PURE__ */ __name2((cx) => {
...
var messageFont = /* @__PURE__ */ __name2((cnf) => {
  return {
...
var noteFont = /* @__PURE__ */ __name2((cnf) => {
  return {
...
var actorFont = /* @__PURE__ */ __name2((cnf) => {
  return {
...
var drawMessage = /* @__PURE__ */ __name2(async function(diagram2, msgModel, lineStartY, diagObj, msg, diagramId) {
...
var addActorRenderingData = /* @__PURE__ */ __name2(function(diagram2, actors, createdActors, actorKeys, verticalPos, messages, isFooter) {
  let prevWidth = 0;
  let prevMargin = 0;
  let prevBox = void 0;
  let maxHeight = 0;
...
var drawActors = /* @__PURE__ */ __name2(async function(diagram2, actors, actorKeys, isFooter, diagramId, diagObj, actorIndexMap) {
  if (!isFooter) {
    for (const actorKey of actorKeys) {
      const actor = actors.get(actorKey);
...
var drawActorsPopup = /* @__PURE__ */ __name2(function(diagram2, actors, actorKeys, doc) {
  let maxHeight = 0;
  let maxWidth = 0;
  for (const actorKey of actorKeys) {
    const actor = actors.get(actorKey);
...
var setConf = /* @__PURE__ */ __name2(function(cnf) {
...
var actorActivations = /* @__PURE__ */ __name2(function(actor) {
  return bounds.activations.filter(function(activation) {
    return activation.actor === actor;
  });
}, "actorActivations");
var activationBounds = /* @__PURE__ */ __name2(function(actor, actors) {
...
var draw = /* @__PURE__ */ __name2(async function(_text, id, _version, diagObj) {
...
var getRequiredPopupWidth = /* @__PURE__ */ __name2(function(actor) {
...
var buildNoteModel = /* @__PURE__ */ __name2(async function(msg, actors, diagObj) {
  const fromActor = actors.get(msg.from);
  const toActor = actors.get(msg.to);
...
var hasCentralConnection = /* @__PURE__ */ __name2(function(msg, diagObj) {
  const { CENTRAL_CONNECTION, CENTRAL_CONNECTION_REVERSE, CENTRAL_CONNECTION_DUAL } = diagObj.db.LINETYPE;
...
var calculateCentralConnectionOffset = /* @__PURE__ */ __name2(function(msg, diagObj, isArrowToRight) {
  const {
...
var isReverseArrowType = /* @__PURE__ */ __name2(function(msg, diagObj) {
  const {
...
var isBidirectionalArrowType = /* @__PURE__ */ __name2(function(msg, diagObj) {
...
var buildMessageModel = /* @__PURE__ */ __name2(function(msg, actors, diagObj) {
  const { look } = getConfig2();
  if (![
    diagObj.db.LINETYPE.SOLID_OPEN,
    diagObj.db.LINETYPE.DOTTED_OPEN,
  ...
  const adjustValue = /* @__PURE__ */ __name2((value) => {
...
var calculateLoopBounds = /* @__PURE__ */ __name2(async function(messages, actors, _maxWidthPerActor, diagObj) {
  const loops = {};
  const stack = [];
