...
// ../mermaid/dist/chunks/mermaid.core/diagram-S7CK7UJ4.mjs
var ALL_BOX_CHARS = /[─━│┃└┗├┣]/;
var BRANCH_CHAR = /[└┗├┣]/;
var DASH_CHAR = /[─━]/;
...
__name2(isBoxDrawingFormat, "isBoxDrawingFormat");
...
__name2(inferSegmentWidth, "inferSegmentWidth");
...
__name2(remapErrorLines, "remapErrorLines");
...
__name2(preprocessBoxDrawing, "preprocessBoxDrawing");
...
var getRoot = /* @__PURE__ */ __name2(() => {
  return state.records.stack[0];
}, "getRoot");
var getCount = /* @__PURE__ */ __name2(() => state.records.cnt, "getCount");
...
var addNode = /* @__PURE__ */ __name2((level, name, nodeType, cssClass, icon, description) => {
...
__name2(qualifyIcon, "qualifyIcon");
...
__name2(getNodeIcon, "getNodeIcon");
registerIconPacks([
  {
...
var ICON_GAP = 4;
var DESC_GAP = 16;
var resolveNodeIcons = /* @__PURE__ */ __name2(async (root, config) => {
  const nodeIcons = [];
  const collect = /* @__PURE__ */ __name2((node) => {
...
var positionLabel = /* @__PURE__ */ __name2((x, y, node, domElem, config, iconSVGs) => {
...
var positionLine = /* @__PURE__ */ __name2((domElem, x1, y1, x2, y2, lineThickness) => {
...
var drawTree = /* @__PURE__ */ __name2((elem, root, config, iconSVGs) => {
  let totalHeight = 0;
  let totalWidth = 0;
  const renderInfos = [];
  const drawNode = /* @__PURE__ */ __name2((elem2, node, config2, depth) => {
  ...
  const processNode = /* @__PURE__ */ __name2((node, depth = 0) => {
...
var draw = /* @__PURE__ */ __name2(async (text, id, _ver, diagObj) => {
