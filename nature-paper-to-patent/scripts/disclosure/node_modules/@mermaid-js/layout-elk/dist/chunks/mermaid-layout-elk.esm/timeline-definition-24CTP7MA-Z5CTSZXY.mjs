...
// ../mermaid/dist/chunks/mermaid.core/timeline-definition-24CTP7MA.mjs
var parser = (function() {
...
__export(timelineDb_exports, {
  ...
  getDirection: /* @__PURE__ */ __name(() => getDirection, "getDirection"),
  getSections: /* @__PURE__ */ __name(() => getSections, "getSections"),
  getTasks: /* @__PURE__ */ __name(() => getTasks, "getTasks"),
  setDirection: /* @__PURE__ */ __name(() => setDirection, "setDirection")
});
var currentSection = "";
var currentTaskId = 0;
var direction = "LR";
...
var tasks = [];
var rawTasks = [];
var getCommonDb = /* @__PURE__ */ __name2(() => commonDb_exports, "getCommonDb");
...
var setDirection = /* @__PURE__ */ __name2(function(dir) {
  direction = dir;
}, "setDirection");
...
var addTask = /* @__PURE__ */ __name2(function(period, length, event) {
  const rawTask = {
    id: currentTaskId++,
...
var addEvent = /* @__PURE__ */ __name2(function(event) {
  const currentTask = rawTasks.find((task) => task.id === currentTaskId - 1);
  currentTask.events.push(event);
}, "addEvent");
var addTaskOrg = /* @__PURE__ */ __name2(function(descr) {
  const newTask = {
    section: currentSection,
    type: currentSection,
    description: descr,
...
var nodeCount = 0;
var drawRect = /* @__PURE__ */ __name2(function(elem, rectData) {
...
var drawFace = /* @__PURE__ */ __name2(function(element, faceData) {
  const radius = 15;
...
var drawCircle = /* @__PURE__ */ __name2(function(element, circleData) {
...
var drawSection = /* @__PURE__ */ __name2(function(elem, section, conf) {
...
var taskCount = -1;
var drawTask = /* @__PURE__ */ __name2(function(elem, task, conf, diagramId) {
...
var drawBackgroundRect = /* @__PURE__ */ __name2(function(elem, bounds) {
...
var getTextObj = /* @__PURE__ */ __name2(function() {
  return {
    x: 0,
    y: 0,
    fill: void 0,
...
var getNoteRect = /* @__PURE__ */ __name2(function() {
  return {
    x: 0,
    y: 0,
    width: 100,
...
var initGraphics = /* @__PURE__ */ __name2(function(graphics, id) {
  nodeCount = 0;
  taskCount = -1;
...
__name(wrap, "wrap");
__name2(wrap, "wrap");
var drawNode = /* @__PURE__ */ __name2(function(elem, node, fullSection, conf, diagramId, isEvent = false) {
...
var getVirtualNodeHeight = /* @__PURE__ */ __name2(function(elem, node, conf) {
...
var defaultBkg = /* @__PURE__ */ __name2(function(elem, node, section, diagramId, config) {
  const { theme } = config;
...
var drawTasks = /* @__PURE__ */ __name2(function(diagram2, tasks2, sectionColor, masterX, masterY, maxTaskHeight, conf, maxEventCount, maxEventLineLength, maxSectionHeight, isWithoutSections, diagramId) {
...
var drawEvents = /* @__PURE__ */ __name2(function(diagram2, events, sectionColor, masterX, masterY, conf, diagramId) {
...
var draw2 = /* @__PURE__ */ __name2(function(text, id, version, diagObj) {
  const conf = getConfig2();
  const LEFT_MARGIN = conf.timeline?.leftMargin ?? 50;
  log.debug("timeline", diagObj.db);
...
var drawTasks2 = /* @__PURE__ */ __name2(function(diagram2, tasks2, sectionColor, timelineX, masterY, maxTaskHeight, conf, taskSpacing, isWithoutSections) {
  for (const task of tasks2) {
    const taskNode = {
      descr: task.task,
      section: sectionColor,
...
var drawEvents2 = /* @__PURE__ */ __name2(function(diagram2, events, sectionColor, axisX, eventsX, startY, conf) {
  let currentY = startY;
  for (const event of events) {
    const eventNode = {
      descr: event,
...
var genReduxSections = /* @__PURE__ */ __name2((options) => {
...
var genSections = /* @__PURE__ */ __name2((options) => {
  let sections2 = "";
  for (let i = 0; i < options.THEME_COLOR_LIMIT; i++) {
...
var rendererSelector = {
  ...
  draw: /* @__PURE__ */ __name2((text, id, version, diagObj) => {
