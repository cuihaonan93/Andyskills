...
// ../mermaid/dist/chunks/mermaid.core/chunk-DSNCTWBM.mjs
...
__name2(createLayoutElementGroups, "createLayoutElementGroups");
...
__name2(measureGroupLabel, "measureGroupLabel");
...
__name2(insertMeasuredNode, "insertMeasuredNode");
async function createGraphWithElements(element, data4Layout) {
  ...
  if (globalThis.mermaidCaptureSizes) {
    const { captureNodeSizes } = await import("./sizeCapture-X5ZJPWSS-PSGVOMYM.mjs");
...
__name2(createGraphWithElements, "createGraphWithElements");
var clusterDb = /* @__PURE__ */ new Map();
var descendants = /* @__PURE__ */ new Map();
var parents = /* @__PURE__ */ new Map();
var clear4 = /* @__PURE__ */ __name2(() => {
  descendants.clear();
  parents.clear();
  clusterDb.clear();
}, "clear");
var isDescendant = /* @__PURE__ */ __name2((id, ancestorId) => {
  const ancestorDescendants = descendants.get(ancestorId) || [];
  log.trace("In isDescendant", ancestorId, " ", id, " = ", ancestorDescendants.includes(id));
  return ancestorDescendants.includes(id);
}, "isDescendant");
var edgeInCluster = /* @__PURE__ */ __name2((edge, clusterId) => {
...
var copy = /* @__PURE__ */ __name2((clusterId, graph, newGraph, rootId) => {
  log.debug(
    "Copying children of ",
    clusterId,
    "root",
...
var extractDescendants = /* @__PURE__ */ __name2((id, graph) => {
...
var findCommonEdges = /* @__PURE__ */ __name2((graph, id1, id2) => {
...
var findNonClusterChild = /* @__PURE__ */ __name2((id, graph, clusterId) => {
  const children = graph.children(id);
...
var getAnchorId = /* @__PURE__ */ __name2((id) => {
  if (!clusterDb.has(id)) {
    return id;
  }
...
var adjustClustersAndEdges = /* @__PURE__ */ __name2((graph, depth) => {
  if (!graph || depth > 10) {
...
var extractor = /* @__PURE__ */ __name2((graph, depth) => {
  if (depth > 10) {
...
var sorter = /* @__PURE__ */ __name2((graph, nodes) => {
  if (nodes.length === 0) {
    return [];
  }
...
var sortNodesByHierarchy = /* @__PURE__ */ __name2((graph) => sorter(graph, graph.children()), "sortNodesByHierarchy");
var isNodeInExtractableCluster = /* @__PURE__ */ __name2((graph, node, rootId) => {
...
var findSafeAnchorNode = /* @__PURE__ */ __name2((graph, clusterId, excludedCluster) => {
...
function createCommonLayoutRenderer({
  ...
  return /* @__PURE__ */ __name2(/* @__PURE__ */ __name(async function render(data4Layout, svg, helpers, options) {
...
__name2(createCommonLayoutRenderer, "createCommonLayoutRenderer");
...
__name2(clearLayoutRenderState, "clearLayoutRenderState");
...
__name2(defaultMeasureLayout, "defaultMeasureLayout");
...
__name2(paintLayoutData, "paintLayoutData");
...
__name2(paintLayoutNode, "paintLayoutNode");
...
__name2(shouldPaintAsCluster, "shouldPaintAsCluster");
...
__name2(buildNodeLookup, "buildNodeLookup");
...
__name2(shouldSkipPaintEdge, "shouldSkipPaintEdge");
...
__name2(paintLayoutEdge, "paintLayoutEdge");
...
__name2(getRenderedNode, "getRenderedNode");
...
__name2(shouldSkipIntersect, "shouldSkipIntersect");
...
__name2(positionRenderedEdgeLabel, "positionRenderedEdgeLabel");
