...
// ../mermaid/dist/chunks/mermaid.core/sankeyDiagram-P5KCCOFB.mjs
import {
  select as d3select,
...
var SankeyLink = class {
  ...
  static {
    __name2(this, "SankeyLink");
  }
};
var addLink = /* @__PURE__ */ __name2((source, target, value2) => {
...
var SankeyNode = class {
  ...
  static {
    __name2(this, "SankeyNode");
  }
};
var findOrCreateNode = /* @__PURE__ */ __name2((ID) => {
...
var getNodes = /* @__PURE__ */ __name2(() => nodes, "getNodes");
var getLinks = /* @__PURE__ */ __name2(() => links, "getLinks");
var getGraph = /* @__PURE__ */ __name2(() => ({
...
var sankeyDB_default = {
  nodesMap,
  getConfig: /* @__PURE__ */ __name2(() => getConfig2().sankey, "getConfig"),
  getNodes,
  getLinks,
  getGraph,
  addLink,
...
var findCentralNodeLayer = /* @__PURE__ */ __name2((nodes2) => {
  let maxValue = 0;
  let centralLayer = 0;
  for (const node of nodes2) {
...
var draw = /* @__PURE__ */ __name2(function(text, id, _version, diagObj) {
  ...
  const getNodeColor = /* @__PURE__ */ __name2((nodeId) => {
  ...
  const getText = /* @__PURE__ */ __name2(({ id: id2, value: value2 }) => {
    if (!showValues) {
      return id2;
    }
    return `${id2}
${prefix}${Math.round(value2 * 100) / 100}${suffix}`;
  ...
  const getLabelPosition = /* @__PURE__ */ __name2((d) => {
  ...
  const appendLabel = /* @__PURE__ */ __name2((className) => labelsGroup.selectAll(className ? `.${className}` : "text").data(graph.nodes).join("text").attr("class", className ?? null).attr("x", (d) => getLabelPosition(d).x).attr("y", (d) => (d.y1 + d.y0) / 2).attr("dy", `${showValues ? "0" : "0.35"}em`).attr("text-anchor", (d) => getLabelPosition(d).anchor).text(getText), "appendLabel");
  if (labelStyle === "outlined") {
  ...
  switch (linkColor) {
    case "gradient":
      coloring = /* @__PURE__ */ __name2((d) => d.uid, "coloring");
      break;
    case "source":
      coloring = /* @__PURE__ */ __name2((d) => getNodeColor(d.source.id), "coloring");
      break;
    case "target":
      coloring = /* @__PURE__ */ __name2((d) => getNodeColor(d.target.id), "coloring");
      break;
    default:
      coloring = linkColor;
  }
...
var prepareTextForParsing = /* @__PURE__ */ __name2((text) => {
