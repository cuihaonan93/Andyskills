...
// ../mermaid/dist/chunks/mermaid.core/diagram-VX7I27RA.mjs
...
var draw = /* @__PURE__ */ __name2((_text, id, _version, diagram2) => {
  ...
  try {
    ...
    if (formatStr === "$0,0") {
      valueFormat = /* @__PURE__ */ __name2((value) => "$" + format(",")(value), "valueFormat");
...
var getClasses = /* @__PURE__ */ __name2(function(_text, diagramObj) {
...
var getStyles = /* @__PURE__ */ __name2(({
  treemap: treemap2
} = {}) => {
