...
// ../mermaid/dist/chunks/mermaid.core/kanban-definition-3QL26DDD.mjs
var parser = (function() {
...
var getSection = /* @__PURE__ */ __name2((level) => {
  if (nodes.length === 0) {
    return null;
  }
...
var getData = /* @__PURE__ */ __name2(function() {
  const edges = [];
  const _nodes = [];
...
var addNode = /* @__PURE__ */ __name2((level, id, descr, type, shapeData) => {
  const conf = getConfig2();
...
var getType = /* @__PURE__ */ __name2((startStr, endStr) => {
...
var setElementForId = /* @__PURE__ */ __name2((id, element) => {
  elements[id] = element;
}, "setElementForId");
var decorateNode = /* @__PURE__ */ __name2((decoration) => {
  if (!decoration) {
    return;
  }
...
var type2Str = /* @__PURE__ */ __name2((type) => {
  switch (type) {
...
var getElementById = /* @__PURE__ */ __name2((id) => elements[id], "getElementById");
var db = {
  clear,
  addNode,
  getSections,
...
var genSections = /* @__PURE__ */ __name2((options) => {
  ...
  const adjuster = /* @__PURE__ */ __name2((color, level) => options.darkMode ? darken_default(color, level) : lighten_default(color, level), "adjuster");
  for (let i = 0; i < options.THEME_COLOR_LIMIT; i++) {
    const sw = "" + (17 - 3 * i);
    sections2 += `
