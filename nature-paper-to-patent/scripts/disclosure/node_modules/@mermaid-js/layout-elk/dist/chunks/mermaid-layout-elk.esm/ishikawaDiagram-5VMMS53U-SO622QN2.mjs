...
// ../mermaid/dist/chunks/mermaid.core/ishikawaDiagram-5VMMS53U.mjs
var parser = (function() {
...
var applyPaddedViewBox = /* @__PURE__ */ __name2((svgEl, pad, maxW) => {
...
var sideStats = /* @__PURE__ */ __name2((nodes) => {
  const countDescendants = /* @__PURE__ */ __name2((node) => node.children.reduce((sum, child) => sum + 1 + countDescendants(child), 0), "countDescendants");
  return nodes.reduce(
    (stats, node) => {
...
var drawHead = /* @__PURE__ */ __name2((svg, x, y, label, fontSize, roughContext) => {
...
var flattenTree = /* @__PURE__ */ __name2((children, direction) => {
  const entries = [];
  const yOrder = [];
  const walk = /* @__PURE__ */ __name2((nodes, pid, depth) => {
...
var drawCauseLabel = /* @__PURE__ */ __name2((svg, text, x, y, direction, fontSize, roughContext) => {
...
var drawArrowMarker = /* @__PURE__ */ __name2((g, x, y, dx, dy, roughContext) => {
...
var drawBranch = /* @__PURE__ */ __name2((svg, node, startX, startY, direction, length, fontSize, roughContext) => {
...
var splitLines = /* @__PURE__ */ __name2((text) => text.split(/<br\s*\/?>|\n/), "splitLines");
var wrapText = /* @__PURE__ */ __name2((text, maxChars) => {
...
var drawMultilineText = /* @__PURE__ */ __name2((g, text, x, y, cls, anchor, fontSize) => {
...
var lerp = /* @__PURE__ */ __name2((a, b, t) => a + (b - a) * t, "lerp");
var drawLine = /* @__PURE__ */ __name2((g, x1, y1, x2, y2, cls, roughContext) => {
  if (roughContext) {
