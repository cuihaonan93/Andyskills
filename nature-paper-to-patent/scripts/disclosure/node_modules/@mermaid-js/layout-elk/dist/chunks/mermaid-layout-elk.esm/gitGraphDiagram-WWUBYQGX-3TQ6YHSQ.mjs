...
import {
  populateCommonDb
} from "./chunk-ENJNQSMA.mjs";
import {
  parse
} from "./chunk-22B37NZ4.mjs";
import "./chunk-PVTWF56Z.mjs";
import "./chunk-5DVX4BTX.mjs";
import "./chunk-3X5J5IMY.mjs";
import "./chunk-EQKYBQ7U.mjs";
import "./chunk-TUI7DAE3.mjs";
import "./chunk-EZXHG4NP.mjs";
import "./chunk-545MWLPI.mjs";
import "./chunk-WKOPQ7OG.mjs";
import "./chunk-VJXIK3EN.mjs";
import "./chunk-6MD5LNKD.mjs";
import "./chunk-ZTAPLGAP.mjs";
import "./chunk-UUQCQ6CX.mjs";
import "./chunk-Z6YY2FJP.mjs";
import "./chunk-QDO5GMJW.mjs";
import "./chunk-SGX53LOX.mjs";
import "./chunk-VAULZL2X.mjs";
import {
  cleanAndMerge,
  random,
  utils_default
...
// ../mermaid/dist/chunks/mermaid.core/gitGraphDiagram-WWUBYQGX.mjs
var commitType = {
  NORMAL: 0,
  REVERSE: 1,
  HIGHLIGHT: 2,
...
var setDirection = /* @__PURE__ */ __name2(function(dir2) {
  state.records.direction = dir2;
}, "setDirection");
var setOptions = /* @__PURE__ */ __name2(function(rawOptString) {
...
var commit = /* @__PURE__ */ __name2(function(commitDB) {
...
var branch = /* @__PURE__ */ __name2(function(branchDB) {
...
var merge = /* @__PURE__ */ __name2((mergeDB) => {
...
var cherryPick = /* @__PURE__ */ __name2(function(cherryPickDB) {
...
var checkout = /* @__PURE__ */ __name2(function(branch2) {
...
var prettyPrint = /* @__PURE__ */ __name2(function() {
...
var getBranchesAsObjArray = /* @__PURE__ */ __name2(function() {
...
var getBranches = /* @__PURE__ */ __name2(function() {
  return state.records.branches;
}, "getBranches");
var getCommits = /* @__PURE__ */ __name2(function() {
  return state.records.commits;
}, "getCommits");
var getCommitsArray = /* @__PURE__ */ __name2(function() {
...
var getCurrentBranch = /* @__PURE__ */ __name2(function() {
  return state.records.currBranch;
}, "getCurrentBranch");
var getDirection = /* @__PURE__ */ __name2(function() {
  return state.records.direction;
}, "getDirection");
var getHead = /* @__PURE__ */ __name2(function() {
...
var populate = /* @__PURE__ */ __name2((ast, db2) => {
...
var parseStatement = /* @__PURE__ */ __name2((statement, db2) => {
  const parsers = {
    Commit: /* @__PURE__ */ __name2((stmt) => db2.commit(parseCommit(stmt)), "Commit"),
    Branch: /* @__PURE__ */ __name2((stmt) => db2.branch(parseBranch(stmt)), "Branch"),
    Merge: /* @__PURE__ */ __name2((stmt) => db2.merge(parseMerge(stmt)), "Merge"),
    Checkout: /* @__PURE__ */ __name2((stmt) => db2.checkout(parseCheckout(stmt)), "Checkout"),
    CherryPicking: /* @__PURE__ */ __name2((stmt) => db2.cherryPick(parseCherryPicking(stmt)), "CherryPicking")
  };
...
var parseCommit = /* @__PURE__ */ __name2((commit2) => {
  const commitDB = {
    id: commit2.id,
    msg: commit2.message ?? "",
...
var parseBranch = /* @__PURE__ */ __name2((branch2) => {
  const branchDB = {
    name: branch2.name,
...
var parseMerge = /* @__PURE__ */ __name2((merge2) => {
  const mergeDB = {
...
var parseCheckout = /* @__PURE__ */ __name2((checkout2) => {
  const branch2 = checkout2.branch;
  return branch2;
}, "parseCheckout");
var parseCherryPicking = /* @__PURE__ */ __name2((cherryPicking) => {
  const cherryPickDB = {
    id: cherryPicking.id,
    targetId: "",
...
var parser = {
  parse: /* @__PURE__ */ __name2(async (input) => {
...
var calcColorIndex = /* @__PURE__ */ __name2((rawIndex, limit, avoidDefaultColor = false) => {
...
var drawText = /* @__PURE__ */ __name2((txt) => {
...
var findClosestParent = /* @__PURE__ */ __name2((parents) => {
  let closestParent;
  let comparisonFunc;
  let targetPosition;
  if (dir === "BT") {
    comparisonFunc = /* @__PURE__ */ __name2((a, b) => a <= b, "comparisonFunc");
...
var findClosestParentBT = /* @__PURE__ */ __name2((parents) => {
  let closestParent = "";
...
var setParallelBTPos = /* @__PURE__ */ __name2((sortedKeys, commits, defaultPos2) => {
...
var findClosestParentPos = /* @__PURE__ */ __name2((commit2) => {
...
var calculateCommitPosition = /* @__PURE__ */ __name2((commit2) => {
  const closestParentPos = findClosestParentPos(commit2);
  return closestParentPos + COMMIT_STEP;
}, "calculateCommitPosition");
var setCommitPosition = /* @__PURE__ */ __name2((commit2, curPos) => {
...
var setRootPosition = /* @__PURE__ */ __name2((commit2, curPos, defaultPos2) => {
  const branch2 = branchPos.get(commit2.branch);
  if (!branch2) {
    throw new Error(`Branch not found for commit ${commit2.id}`);
  }
...
var drawCommitBullet = /* @__PURE__ */ __name2((gBullets, commit2, commitPosition, typeClass, branchIndex, commitSymbolType) => {
...
var drawCommitLabel = /* @__PURE__ */ __name2((gLabels, commit2, commitPosition, pos, gitGraphConfig) => {
...
var drawCommitTags = /* @__PURE__ */ __name2((gLabels, commit2, commitPosition, pos) => {
...
var getCommitClassType = /* @__PURE__ */ __name2((commit2) => {
...
var calculatePosition = /* @__PURE__ */ __name2((commit2, dir2, pos, commitPos2) => {
...
var getCommitPosition = /* @__PURE__ */ __name2((commit2, pos, isParallelCommits) => {
...
var drawCommits = /* @__PURE__ */ __name2((svg, commits, modifyGraph, gitGraphConfig) => {
  const gBullets = svg.append("g").attr("class", "commit-bullets");
  const gLabels = svg.append("g").attr("class", "commit-labels");
  let pos = dir === "TB" || dir === "BT" ? defaultPos : 0;
  const keys = [...commits.keys()];
  const isParallelCommits = gitGraphConfig.parallelCommits ?? false;
  const sortKeys = /* @__PURE__ */ __name2((a, b) => {
...
var shouldRerouteArrow = /* @__PURE__ */ __name2((commitA, commitB, p1, p2, allCommits) => {
  const commitBIsFurthest = dir === "TB" || dir === "BT" ? p1.x < p2.x : p1.y < p2.y;
  const branchToGetCurve = commitBIsFurthest ? commitB.branch : commitA.branch;
  const isOnBranchToGetCurve = /* @__PURE__ */ __name2((x) => x.branch === branchToGetCurve, "isOnBranchToGetCurve");
  const isBetweenCommits = /* @__PURE__ */ __name2((x) => x.seq > commitA.seq && x.seq < commitB.seq, "isBetweenCommits");
  return [...allCommits.values()].some((commitX) => {
    return isBetweenCommits(commitX) && isOnBranchToGetCurve(commitX);
  });
}, "shouldRerouteArrow");
var findLane = /* @__PURE__ */ __name2((y1, y2, depth = 0) => {
...
var drawArrow = /* @__PURE__ */ __name2((svg, commitA, commitB, allCommits) => {
...
var drawArrows = /* @__PURE__ */ __name2((svg, commits) => {
...
var drawBranches = /* @__PURE__ */ __name2((svg, branches, gitGraphConfig, id) => {
...
var setBranchPosition = /* @__PURE__ */ __name2(function(name, pos, index, bbox, rotateCommitLabel) {
  branchPos.set(name, { pos, index });
  pos += 50 + (rotateCommitLabel ? 40 : 0) + (dir === "TB" || dir === "BT" ? bbox.width / 2 : 0);
  return pos;
}, "setBranchPosition");
var draw = /* @__PURE__ */ __name2(function(txt, id, ver, diagObj) {
  clear3();
...
if (void 0) {
  ...
  describe("branchPosition", () => {
    const bbox = {
      ...
      bottom: 0,
      left: 0,
      toJSON: /* @__PURE__ */ __name2(() => "", "toJSON")
    };
...
var genGitGraphGradient = /* @__PURE__ */ __name2((options) => {
  const { svgId } = options;
  let sections = "";
...
var genColor = /* @__PURE__ */ __name2((options) => {
...
var normalTheme = /* @__PURE__ */ __name2((options) => {
