...
// ../mermaid/dist/chunks/mermaid.core/vennDiagram-4TSXK5OY.mjs
...
var addSubsetData = /* @__PURE__ */ __name2((identifierList, label, size) => {
...
var getSubsetData = /* @__PURE__ */ __name2(() => {
  return subsets;
}, "getSubsetData");
var normalizeText = /* @__PURE__ */ __name2((text) => {
...
var normalizeStyleValue = /* @__PURE__ */ __name2((value) => {
  return value ? normalizeText(value) : value;
}, "normalizeStyleValue");
var addTextData = /* @__PURE__ */ __name2((identifierList, id, label) => {
...
var addStyleData = /* @__PURE__ */ __name2((identifierList, data) => {
...
var getStyleData = /* @__PURE__ */ __name2(() => {
  return styleEntries;
}, "getStyleData");
var normalizeIdentifierList = /* @__PURE__ */ __name2((identifierList) => {
  return identifierList.map((identifier) => normalizeText(identifier));
}, "normalizeIdentifierList");
var validateUnionIdentifiers = /* @__PURE__ */ __name2((identifierList) => {
...
var getTextData = /* @__PURE__ */ __name2(() => {
  return textNodes;
}, "getTextData");
var getCurrentSets = /* @__PURE__ */ __name2(() => currentSets, "getCurrentSets");
var getIndentMode = /* @__PURE__ */ __name2(() => indentMode, "getIndentMode");
var setIndentMode = /* @__PURE__ */ __name2((enabled) => {
  indentMode = enabled;
}, "setIndentMode");
...
__name(getConfig2, "getConfig2");
__name2(getConfig2, "getConfig");
var customClear = /* @__PURE__ */ __name2(() => {
  clear();
  subsets.length = 0;
  textNodes.length = 0;
...
__name2(buildStyleByKey, "buildStyleByKey");
var draw = /* @__PURE__ */ __name2((_text, id, _version, diagObj) => {
...
__name2(stableSetsKey, "stableSetsKey");
...
__name2(renderTextNodes, "renderTextNodes");
...
__name2(ensurePairwiseSubsets, "ensurePairwiseSubsets");
var renderer = { draw };
var diagram = {
  parser: venn_default,
  db,
