...
// ../mermaid/dist/chunks/mermaid.core/wardleyDiagram-VM6X3IG4.mjs
var toPercent = /* @__PURE__ */ __name2((value, context) => {
...
var toCoordinates = /* @__PURE__ */ __name2((visibility, evolution, context) => {
  return {
    x: toPercent(evolution, `${context} evolution`),
    y: toPercent(visibility, `${context} visibility`)
  };
}, "toCoordinates");
var getFlowFromPort = /* @__PURE__ */ __name2((port) => {
  if (!port) {
    return void 0;
  }
  if (port === "+<>") {
...
var extractFlowFromArrow = /* @__PURE__ */ __name2((arrow) => {
  if (!arrow?.startsWith("+")) {
    return {};
  }
...
__name(getConfig3, "getConfig3");
__name2(getConfig3, "getConfig");
...
__name2(addAnnotation, "addAnnotation");
...
__name2(addAccelerator, "addAccelerator");
...
__name2(addPipelineComponent, "addPipelineComponent");
function updateAxes(partial) {
  builder.setAxes(partial);
}
__name(updateAxes, "updateAxes");
__name2(updateAxes, "updateAxes");
function getNode(id) {
...
__name2(resolveNodeId, "resolveNodeId");
function getWardleyData() {
  return builder.build();
}
__name(getWardleyData, "getWardleyData");
__name2(getWardleyData, "getWardleyData");
function clear2() {
  builder.clear();
  clear();
}
__name(clear2, "clear2");
__name2(clear2, "clear");
...
var getConfigValues = /* @__PURE__ */ __name2(() => {
...
var draw = /* @__PURE__ */ __name2((text, id, _version, diagObj) => {
  ...
  const projectX = /* @__PURE__ */ __name2((value) => configValues.padding + value / 100 * chartWidth, "projectX");
  const projectY = /* @__PURE__ */ __name2((value) => height - configValues.padding - value / 100 * chartHeight, "projectY");
