...
// ../mermaid/dist/chunks/mermaid.core/blockDiagram-NRAW4CY4.mjs
...
var diagramId = "";
var sanitizeText = /* @__PURE__ */ __name2((txt) => common_default.sanitizeText(txt, getConfig2()), "sanitizeText");
var addStyleClass = /* @__PURE__ */ __name2(function(id, styleAttributes = "") {
...
var addStyle2Node = /* @__PURE__ */ __name2(function(id, styles = "") {
  const foundBlock = blockDatabase.get(id);
  if (styles !== void 0 && styles !== null) {
    foundBlock.styles = styles.split(STYLECLASS_SEP);
  }
}, "addStyle2Node");
var setCssClass = /* @__PURE__ */ __name2(function(itemIds, cssClassName) {
...
var populateBlockDatabase = /* @__PURE__ */ __name2((_blockList, parent) => {
...
__name2(edgeStrToPattern, "edgeStrToPattern");
var cnt = 0;
var generateId = /* @__PURE__ */ __name2(() => {
  cnt++;
  return "id-" + Math.random().toString(36).substr(2, 12) + "-" + cnt;
}, "generateId");
var setHierarchy = /* @__PURE__ */ __name2((block) => {
  rootBlock.children = block;
  populateBlockDatabase(block, rootBlock);
  blocks = rootBlock.children;
}, "setHierarchy");
var getColumns = /* @__PURE__ */ __name2((blockId) => {
...
var getBlocksFlat = /* @__PURE__ */ __name2(() => {
  return [...blockDatabase.values()];
}, "getBlocksFlat");
var getBlocks = /* @__PURE__ */ __name2(() => {
  return blocks || [];
}, "getBlocks");
var getEdges = /* @__PURE__ */ __name2(() => {
  return edgeList;
}, "getEdges");
var getBlock = /* @__PURE__ */ __name2((id) => {
  return blockDatabase.get(id);
}, "getBlock");
var setBlock = /* @__PURE__ */ __name2((block) => {
  blockDatabase.set(block.id, block);
}, "setBlock");
var setDiagramId = /* @__PURE__ */ __name2((id) => {
  diagramId = id;
}, "setDiagramId");
var getDiagramId = /* @__PURE__ */ __name2(() => diagramId, "getDiagramId");
var getLogger = /* @__PURE__ */ __name2(() => log, "getLogger");
var getClasses = /* @__PURE__ */ __name2(function() {
  return classes;
}, "getClasses");
var db = {
  getConfig: /* @__PURE__ */ __name2(() => getConfig().block, "getConfig"),
  typeStr2Type,
  edgeTypeStr2Type,
  edgeStrToEdgeData,
...
var fade = /* @__PURE__ */ __name2((color, opacity) => {
...
var getMaxChildSize = /* @__PURE__ */ __name2((block) => {
  let maxWidth = 0;
  let maxHeight = 0;
...
var getClasses2 = /* @__PURE__ */ __name2(function(text, diagObj) {
  return diagObj.db.getClasses();
}, "getClasses");
var draw = /* @__PURE__ */ __name2(async function(text, id, _version, diagObj) {
