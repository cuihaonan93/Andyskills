...
// ../mermaid/dist/chunks/mermaid.core/chunk-RHFEMEQ7.mjs
...
You have to call mermaid.initialize.`
  ...
  getData() {
    ...
    const isCollapsed = /* @__PURE__ */ __name2((sgId) => this.subGraphLookup.get(sgId)?.metadata?.view === "collapsed", "isCollapsed");
    const outermostCollapsed = /* @__PURE__ */ __name2((sgId) => {
      let result;
...
var createFlowDiagram = /* @__PURE__ */ __name2(({
  defaultLayout,
