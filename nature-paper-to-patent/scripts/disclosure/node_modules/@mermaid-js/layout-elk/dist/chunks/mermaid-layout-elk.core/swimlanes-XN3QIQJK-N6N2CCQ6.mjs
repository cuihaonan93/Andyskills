...
// ../mermaid/dist/chunks/mermaid.core/swimlanes-XN3QIQJK.mjs
...
__name2(buildSegmentList, "buildSegmentList");
...
__name2(segmentIntersection, "segmentIntersection");
...
__name2(isHorizontalSeg, "isHorizontalSeg");
...
__name2(findEdgeIntersections, "findEdgeIntersections");
function fmt(n) {
...
__name2(pointToString, "pointToString");
...
__name2(getArcSweepFlag, "getArcSweepFlag");
...
__name2(applyMarkerOffsets, "applyMarkerOffsets");
...
__name2(computeRoundedCorner, "computeRoundedCorner");
...
__name2(curveSupportsLineHops, "curveSupportsLineHops");
...
__name2(decodeDataPoints, "decodeDataPoints");
...
__name2(applyLineJumpsToSvg, "applyLineJumpsToSvg");
...
__name2(applySwimlaneLineJumps, "applySwimlaneLineJumps");
...
__name2(topLaneHorizontalPadding, "topLaneHorizontalPadding");
...
__name2(assignTopLaneTitleRect, "assignTopLaneTitleRect");
...
__name2(prepareLayoutForSwimlanes, "prepareLayoutForSwimlanes");
...
__name2(toGraphView, "toGraphView");
...
__name2(writeBackToLayoutData, "writeBackToLayoutData");
...
__name2(createEdgeLabelNodes, "createEdgeLabelNodes");
var EPS = 1e-3;
...
__name2(measuredNodeRect, "measuredNodeRect");
...
__name2(isHorizontalSegment, "isHorizontalSegment");
...
__name2(isVerticalSegment, "isVerticalSegment");
...
__name2(overlapLength, "overlapLength");
...
__name2(sameAxisSegmentOverlapLength, "sameAxisSegmentOverlapLength");
...
__name2(orthogonalSegmentsForPoints, "orthogonalSegmentsForPoints");
...
__name2(countOrthogonalBends, "countOrthogonalBends");
...
__name2(dedupeConsecutivePoints, "dedupeConsecutivePoints");
...
__name2(classifyThreeSegmentRoute, "classifyThreeSegmentRoute");
...
__name2(segmentBoundsOverlapRect, "segmentBoundsOverlapRect");
...
__name2(pointInsideRect, "pointInsideRect");
...
__name2(rectContainsRect, "rectContainsRect");
function rectsOverlap(a, b) {
  return a.left < b.right && a.right > b.left && a.top < b.bottom && a.bottom > b.top;
}
__name(rectsOverlap, "rectsOverlap");
__name2(rectsOverlap, "rectsOverlap");
...
__name2(inflateRect, "inflateRect");
...
__name2(portForRectSide, "portForRectSide");
...
__name2(buildOrthogonalPortPath, "buildOrthogonalPortPath");
...
__name2(buildSameSideTrackPath, "buildSameSideTrackPath");
...
__name2(collectRealNodeBounds, "collectRealNodeBounds");
...
__name2(collectNodeRectEntries, "collectNodeRectEntries");
...
__name2(collectLayoutNodeRects, "collectLayoutNodeRects");
...
__name2(getNodePairGeometry, "getNodePairGeometry");
...
__name2(segmentHitsAnyRect, "segmentHitsAnyRect");
...
__name2(orthogonalSegmentsCross, "orthogonalSegmentsCross");
...
__name2(sameAxisSegmentsOverlap, "sameAxisSegmentsOverlap");
...
__name2(segmentConflictsWithAnyEdge, "segmentConflictsWithAnyEdge");
...
__name2(orthogonalSegmentsStrictlyCross, "orthogonalSegmentsStrictlyCross");
...
__name2(strictlyBetween, "strictlyBetween");
...
__name2(isCollinearIntermediate, "isCollinearIntermediate");
...
__name2(simplifyPolylineOnce, "simplifyPolylineOnce");
...
__name2(orthogonalizePolyline, "orthogonalizePolyline");
...
__name2(simplifyPolyline, "simplifyPolyline");
var EPS2 = 1e-3;
var INSIDE_EPS = 0.5;
...
__name2(endpointContextFor, "endpointContextFor");
...
__name2(segmentEnterPoint, "segmentEnterPoint");
...
__name2(clipEndpoint, "clipEndpoint");
...
__name2(clipEdgeEndpointsToNodeBoundaries, "clipEdgeEndpointsToNodeBoundaries");
...
__name2(snapEndpointToBoundary, "snapEndpointToBoundary");
...
__name2(firstDistinctAdjacent, "firstDistinctAdjacent");
...
__name2(cornerClearanceRange, "cornerClearanceRange");
...
__name2(clampToCornerClearance, "clampToCornerClearance");
...
__name2(intersectRanges, "intersectRanges");
...
__name2(clearanceRangeForSide, "clearanceRangeForSide");
...
__name2(terminalSideForSegment, "terminalSideForSegment");
function isHorizontalSide(side) {
  return side === "left" || side === "right";
}
__name(isHorizontalSide, "isHorizontalSide");
__name2(isHorizontalSide, "isHorizontalSide");
...
__name2(straightClearanceRange, "straightClearanceRange");
...
__name2(clearStraightEndpointCornerAxis, "clearStraightEndpointCornerAxis");
...
__name2(clearStraightEndpointCornerConnections, "clearStraightEndpointCornerConnections");
...
__name2(cornerClearedEndpoint, "cornerClearedEndpoint");
...
__name2(moveCollinearEndpointRun, "moveCollinearEndpointRun");
...
__name2(clearEndpointCornerConnection, "clearEndpointCornerConnection");
...
__name2(borderSideForSegment, "borderSideForSegment");
...
__name2(leavesOutward, "leavesOutward");
...
__name2(collapseOwnBorderStub, "collapseOwnBorderStub");
...
__name2(snapAndCollapseEndpoints, "snapAndCollapseEndpoints");
...
__name2(prepareEdgeEndpointsForRenderer, "prepareEdgeEndpointsForRenderer");
function buildNodeMap(nodes) {
  return new Map(nodes.map((node) => [node.id, node]));
}
__name(buildNodeMap, "buildNodeMap");
__name2(buildNodeMap, "buildNodeMap");
...
__name2(resolveTopLevelGroupId, "resolveTopLevelGroupId");
...
__name2(boundsForChildren, "boundsForChildren");
...
__name2(applyGroupBounds, "applyGroupBounds");
...
__name2(recomputeNestedGroupBounds, "recomputeNestedGroupBounds");
function mirrorAxis(layout, axis) {
  ...
  const mirror = /* @__PURE__ */ __name2((value) => min + max - value, "mirror");
  for (const node of nodes) {
    const value = node[axis];
    if (typeof value === "number") {
...
__name2(applyBtDirectionTransform, "applyBtDirectionTransform");
...
__name2(applyLrDirectionTransform, "applyLrDirectionTransform");
var EPS3 = 1e-6;
...
__name2(portSwapToLShape, "portSwapToLShape");
function collapseShortTerminalStub(edges, nodeByIdMap) {
  ...
  for (const edge of edges) {
    ...
    const ownSegmentKey = /* @__PURE__ */ __name2((a, b) => `${a.x.toFixed(3)},${a.y.toFixed(3)}|${b.x.toFixed(3)},${b.y.toFixed(3)}`, "ownSegmentKey");
    const selfSegments = /* @__PURE__ */ new Set();
    for (let i = 0; i < pts.length - 1; i++) {
      selfSegments.add(ownSegmentKey(pts[i], pts[i + 1]));
    }
    const segmentCrossesOtherEdge = /* @__PURE__ */ __name2((from, to) => {
      for (const other of edges) {
        if (other === edge) {
          continue;
        }
...
__name2(collapseShortTerminalStub, "collapseShortTerminalStub");
var EPS_LOCAL = 1e-3;
var MIN_SHARED = 8;
var segmentsFor = orthogonalSegmentsForPoints;
var orthogonallyAligned = /* @__PURE__ */ __name2((a, b) => sameX(a, b, EPS_LOCAL) || sameY(a, b, EPS_LOCAL), "orthogonallyAligned");
function separateSharedRenderedTerminalLanes(edges, nodeByIdMap) {
  const MIN_FACE_CLEARANCE = 16;
  const TRACK_SHIFT = 7;
  const rectIntersect = /* @__PURE__ */ __name2((node, point) => {
    const x = node.x ?? 0;
    const y = node.y ?? 0;
    const dx = point.x - x;
    const dy = point.y - y;
  ...
  const terminalLaneFor = /* @__PURE__ */ __name2((edge, atStart) => {
  ...
  const projectedOverlapLength = /* @__PURE__ */ __name2((a, b) => Math.max(0, Math.min(a.max, b.max) - Math.max(a.min, b.min)), "projectedOverlapLength");
  const sameTerminalFace = /* @__PURE__ */ __name2((a, b) => {
  ...
  const exactTerminalLaneConflict = /* @__PURE__ */ __name2((a, b) => {
    if (a.nodeId !== b.nodeId || a.orientation !== b.orientation) {
      return false;
    }
  ...
  const nearTerminalLaneConflict = /* @__PURE__ */ __name2((a, b) => {
  ...
  const shiftedCandidate = /* @__PURE__ */ __name2((lane, shift) => {
    ...
    const boundaryStaysOnSameFace = /* @__PURE__ */ __name2(() => {
  ...
  const laneIsStraightCollinearConnector = /* @__PURE__ */ __name2((lane) => {
...
__name2(separateSharedRenderedTerminalLanes, "separateSharedRenderedTerminalLanes");
function collapseRedundantRectangularDoglegs(edges, nodeByIdMap) {
  ...
  const candidateIsSafe = /* @__PURE__ */ __name2((edge, candidate) => {
  ...
  const withoutDogleg = /* @__PURE__ */ __name2((points, i) => {
...
__name2(collapseRedundantRectangularDoglegs, "collapseRedundantRectangularDoglegs");
function liftObstacleHuggingSameSideRails(edges, nodeByIdMap) {
  ...
  const pointsFor = /* @__PURE__ */ __name2((edge, replacementEdge, replacement) => dedupeConsecutivePoints(
    edge === replacementEdge ? replacement ?? [] : edge.points ?? []
  ), "pointsFor");
  const strictCrossingCount = /* @__PURE__ */ __name2((replacementEdge, replacement) => {
    let count = 0;
  ...
  const middleRail = /* @__PURE__ */ __name2((points) => {
  ...
  const blockingRectsFor = /* @__PURE__ */ __name2((edge, rail) => {
  ...
  const candidateByMovingRail = /* @__PURE__ */ __name2((points, rail, coord) => {
  ...
  const candidateIsSafe = /* @__PURE__ */ __name2((edge, candidate, currentCrossings) => {
    const endpointIds = [edge.start, edge.end].filter(
      (id) => Boolean(id)
    );
    const candidateSegments = segmentsFor(candidate);
...
__name2(liftObstacleHuggingSameSideRails, "liftObstacleHuggingSameSideRails");
function liftTopLaneTitleBandsAboveRails(edges, nodeByIdMap) {
  const CLEARANCE = 4;
  const validTitleRect = /* @__PURE__ */ __name2((node) => {
  ...
  const topLaneTitleFor = /* @__PURE__ */ __name2((node) => {
    if (!node.isGroup || node.parentId) {
      return void 0;
    }
  ...
  const horizontalSegmentIntersectsTitle = /* @__PURE__ */ __name2((segment, rect) => {
...
__name2(liftTopLaneTitleBandsAboveRails, "liftTopLaneTitleBandsAboveRails");
function shiftLeftLaneTitleBandsLeftOfRails(edges, nodeByIdMap) {
  ...
  const leftLaneTitleFor = /* @__PURE__ */ __name2((node) => {
    if (!node.isGroup || node.parentId) {
      return void 0;
    }
    const rawDirection = node.direction;
  ...
  const verticalSegmentIntersectsTitle = /* @__PURE__ */ __name2((segment, rect) => {
    if (!segment.vertical) {
      return false;
    }
    const x = segment.a.x;
...
__name2(shiftLeftLaneTitleBandsLeftOfRails, "shiftLeftLaneTitleBandsLeftOfRails");
function swapDestinationTerminalTailsToReduceCrossings(edges, nodeByIdMap) {
  ...
  const visibleEdges = edges.filter((edge) => !edge.isLayoutOnly);
  const replacementPointsFor = /* @__PURE__ */ __name2((edge, replacements = /* @__PURE__ */ new Map()) => dedupeConsecutivePoints(
    replacements.get(edge) ?? edge.points ?? []
  ), "replacementPointsFor");
  const crossingCount = /* @__PURE__ */ __name2((replacements = /* @__PURE__ */ new Map()) => {
    let count = 0;
    for (let i = 0; i < visibleEdges.length; i++) {
  ...
  const totalBends = /* @__PURE__ */ __name2((replacements = /* @__PURE__ */ new Map()) => visibleEdges.reduce(
    (sum, edge) => sum + countOrthogonalBends(replacementPointsFor(edge, replacements)),
    0
  ), "totalBends");
  const terminalTailFor = /* @__PURE__ */ __name2((edge) => {
  ...
  const candidateWithDestinationTail = /* @__PURE__ */ __name2((edge, tail) => {
    const points = replacementPointsFor(edge);
    if (points.length < 3) {
      return void 0;
    }
  ...
  const pathHasNodeHit = /* @__PURE__ */ __name2((edge, path) => {
    const endpointIds = [edge.start, edge.end].filter(
      (id) => Boolean(id)
    );
  ...
  const pathHasSharedTrack = /* @__PURE__ */ __name2((edge, path, replacements) => {
    for (const other of visibleEdges) {
      if (other === edge) {
        continue;
      }
  ...
  const candidateIsSafe = /* @__PURE__ */ __name2((edge, path, replacements) => !pathHasNodeHit(edge, path) && !pathHasSharedTrack(edge, path, replacements), "candidateIsSafe");
  const edgesByDestination = /* @__PURE__ */ __name2(() => {
...
__name2(swapDestinationTerminalTailsToReduceCrossings, "swapDestinationTerminalTailsToReduceCrossings");
function reassignCrossingExternalRailChannels(edges, nodeByIdMap) {
  ...
  const strictCrossingCount = /* @__PURE__ */ __name2((replacements = /* @__PURE__ */ new Map()) => {
    let count = 0;
    for (let i = 0; i < visibleEdges.length; i++) {
      const firstSegments = segmentsFor(replacementPointsFor(visibleEdges[i], replacements));
      for (let j = i + 1; j < visibleEdges.length; j++) {
  ...
  const endpointRectsFor = /* @__PURE__ */ __name2((edge) => {
    const srcId = edge.start;
    const dstId = edge.end;
  ...
  const externalRailForSegment = /* @__PURE__ */ __name2((edge, points, segment) => {
  ...
  const collectExternalRails = /* @__PURE__ */ __name2(() => {
    const rails = [];
    for (const edge of visibleEdges) {
      const points = replacementPointsFor(edge);
      for (const segment of segmentsFor(points)) {
  ...
  const railsInteract = /* @__PURE__ */ __name2((a, b) => a.edge !== b.edge && a.axis === b.axis && a.side === b.side && overlapLength(a.min, a.max, b.min, b.max) >= MIN_SHARED, "railsInteract");
  const connectedComponents = /* @__PURE__ */ __name2((rails) => {
    const result = [];
  ...
  const uniqueCoordsFor = /* @__PURE__ */ __name2((component) => {
    const coords = [];
  ...
  const coordinateAssignmentsFor = /* @__PURE__ */ __name2((component) => {
  ...
  const replacementsForAssignment = /* @__PURE__ */ __name2((component, assignment) => {
  ...
  const candidateIsSafe = /* @__PURE__ */ __name2((replacements) => {
...
__name2(reassignCrossingExternalRailChannels, "reassignCrossingExternalRailChannels");
function shortcutRedundantOrthogonalJogs(edges, nodeByIdMap) {
  ...
  const pathLength = /* @__PURE__ */ __name2((points) => segmentsFor(points).reduce((sum, segment) => {
  ...
  const segmentRunsAlongRectBorder = /* @__PURE__ */ __name2((segment, rect) => {
    if (segment.horizontal) {
      const y = segment.a.y;
  ...
  const shortcutCandidatesAt = /* @__PURE__ */ __name2((points, index) => {
...
__name2(shortcutRedundantOrthogonalJogs, "shortcutRedundantOrthogonalJogs");
function resolveRenderedOrthogonalCrossings(edges, nodeByIdMap) {
  ...
  const outwardTracksForSide = /* @__PURE__ */ __name2((side) => {
  ...
  const crossingCountBetweenSegments = /* @__PURE__ */ __name2((firstSegments, secondSegments) => {
    let count = 0;
    for (const firstSegment of firstSegments) {
      for (const secondSegment of secondSegments) {
        if (orthogonalSegmentsStrictlyCross(
  ...
  const crossingCountBetweenPaths = /* @__PURE__ */ __name2((first, second) => crossingCountBetweenSegments(segmentsFor(first), segmentsFor(second)), "crossingCountBetweenPaths");
  const crossingSnapshot = /* @__PURE__ */ __name2((replacements = /* @__PURE__ */ new Map()) => {
    let count = 0;
    const pairs = [];
    const edgeSet = /* @__PURE__ */ new Set();
    const edgeOrder = [];
    const addEdge = /* @__PURE__ */ __name2((edge) => {
      if (!edgeSet.has(edge)) {
        edgeSet.add(edge);
        edgeOrder.push(edge);
      }
  ...
  const crossingCountWithReplacements = /* @__PURE__ */ __name2((current, replacements) => {
  ...
  const crossingComponents = /* @__PURE__ */ __name2((snapshot) => {
  ...
  const endpointIdsFor = /* @__PURE__ */ __name2((edge) => [edge.start, edge.end].filter(
    (id) => Boolean(id)
  ), "endpointIdsFor");
  const pairSearchGroups = /* @__PURE__ */ __name2((snapshot) => {
    const groups = [];
  ...
  const crossingCountWithSingleReplacement = /* @__PURE__ */ __name2((current, edge, replacement) => crossingCountWithReplacements(
    current,
    /* @__PURE__ */ new Map([[edge, replacement]])
  ), "crossingCountWithSingleReplacement");
  const currentCrossingsByEdge = /* @__PURE__ */ __name2((current) => {
    const result = /* @__PURE__ */ new Map();
    for (const pair of current.pairs) {
  ...
  const pathLength = /* @__PURE__ */ __name2((points) => points.slice(1).reduce((sum, point, index) => {
  ...
  const totalLength = /* @__PURE__ */ __name2((replacements = /* @__PURE__ */ new Map()) => visibleEdges.reduce(
    (sum, edge) => sum + pathLength(replacementPointsFor(edge, replacements)),
    0
  ), "totalLength");
  const pathHasSegmentConflict = /* @__PURE__ */ __name2((edge, path, replacements = /* @__PURE__ */ new Map()) => {
  ...
  const pathHitsNode = /* @__PURE__ */ __name2((edge, path) => {
    const endpointIds = [edge.start, edge.end].filter(
      (id) => Boolean(id)
    );
    for (const segment of segmentsFor(path)) {
  ...
  const pushOrthogonalCandidate = /* @__PURE__ */ __name2((candidates, points) => {
    const candidate = simplifyPolyline(dedupeConsecutivePoints(points));
    if (segmentsFor(candidate).length === candidate.length - 1) {
      candidates.push(candidate);
    }
  }, "pushOrthogonalCandidate");
  const sideIsHorizontal = /* @__PURE__ */ __name2((side) => side === "left" || side === "right", "sideIsHorizontal");
  const localTrackForSameSide = /* @__PURE__ */ __name2((src, side, dst) => {
    switch (side) {
      case "left":
  ...
  const addSameSideCandidates = /* @__PURE__ */ __name2((candidates, src, srcSide, dst) => {
  ...
  const addHorizontalToVerticalCandidates = /* @__PURE__ */ __name2((candidates, src, srcSide, dst, dstSide) => {
  ...
  const addVerticalToHorizontalCandidates = /* @__PURE__ */ __name2((candidates, src, srcSide, dst, dstSide) => {
  ...
  const addHorizontalPairCandidates = /* @__PURE__ */ __name2((candidates, src, srcSide, dst, dstSide) => {
  ...
  const addVerticalPairCandidates = /* @__PURE__ */ __name2((candidates, src, srcSide, dst, dstSide) => {
  ...
  const dedupeCandidatePaths = /* @__PURE__ */ __name2((candidates) => {
    const seen = /* @__PURE__ */ new Set();
  ...
  const buildCandidatesForSides = /* @__PURE__ */ __name2((src, srcSide, dst, dstSide) => {
    const candidates = [];
  ...
  const addVerticalDepartureOuterTrackCandidates = /* @__PURE__ */ __name2((candidates, first, departure, dstNode) => {
  ...
  const addHorizontalDepartureOuterTrackCandidates = /* @__PURE__ */ __name2((candidates, first, departure, dstNode) => {
    const externalXTracks = [...outwardTracksForSide("left"), ...outwardTracksForSide("right")];
    const externalYTracks = [...outwardTracksForSide("top"), ...outwardTracksForSide("bottom")];
    for (const side of sides) {
      const dst = portForRectSide(dstNode, side);
  ...
  const terminalPreservingOuterTrackCandidates = /* @__PURE__ */ __name2((edge) => {
    const srcId = edge.start;
    const dstId = edge.end;
  ...
  const candidatePathsFor = /* @__PURE__ */ __name2((edge) => {
    const srcId = edge.start;
    const dstId = edge.end;
  ...
  const currentSegmentsByEdge = /* @__PURE__ */ __name2(() => new Map(visibleEdges.map((edge) => [edge, segmentsFor(replacementPointsFor(edge))])), "currentSegmentsByEdge");
  const sharedTrackConflictsFor = /* @__PURE__ */ __name2((edge, candidateSegments, baseSegments) => {
  ...
  const pairCandidatesFor = /* @__PURE__ */ __name2((edge, current, baseSegments, crossingCountByEdge) => {
    const seen = /* @__PURE__ */ new Set();
  ...
  const pairCrossingCount = /* @__PURE__ */ __name2((current, firstEdge, firstCandidate, secondEdge, secondCandidate, baseSegments) => {
    let currentAffected = 0;
    for (const pair of current.pairs) {
  ...
  const conflictsOnlyWith = /* @__PURE__ */ __name2((candidate, edge) => {
  ...
  const candidatesShareTrack = /* @__PURE__ */ __name2((firstCandidate, secondCandidate) => firstCandidate.segments.some(
  ...
  const pairCandidatesAreCompatible = /* @__PURE__ */ __name2((first, firstCandidate, second, secondCandidate) => conflictsOnlyWith(firstCandidate, second.edge) && conflictsOnlyWith(secondCandidate, first.edge) && !candidatesShareTrack(firstCandidate, secondCandidate), "pairCandidatesAreCompatible");
  const scorePairReplacement = /* @__PURE__ */ __name2((context, first, firstCandidate, second, secondCandidate) => {
  ...
  const pairScoreIsBetter = /* @__PURE__ */ __name2((candidate, best) => candidate.crossings < best.crossings || candidate.crossings === best.crossings && (candidate.bends < best.bends || candidate.bends === best.bends && candidate.length < best.length), "pairScoreIsBetter");
  const bestScoreForOptionPair = /* @__PURE__ */ __name2((context, first, second, best) => {
    let pairBest = best;
  ...
  const bestPairedReplacement = /* @__PURE__ */ __name2((current) => {
    const currentBends = totalBends();
...
__name2(resolveRenderedOrthogonalCrossings, "resolveRenderedOrthogonalCrossings");
var EPS4 = 1e-3;
var MIN_SHARED2 = 8;
function simplifyDetouredEdges(edges, nodes) {
  ...
  const buildOrthogonalPathCandidates = /* @__PURE__ */ __name2((src, srcSide, dst, dstSide) => {
    const paths = [];
  ...
  const pathHitsNode = /* @__PURE__ */ __name2((pts, excludeIds) => {
    for (let i = 0; i < pts.length - 1; i++) {
      const a = pts[i];
      const b = pts[i + 1];
  ...
  const pathConflictCount = /* @__PURE__ */ __name2((path, currentEdge, includeIncidentEdges = false) => {
    let conflicts = 0;
  ...
  const nearestSideOfRect = /* @__PURE__ */ __name2((pt, info) => {
  ...
  const addFaceClaim = /* @__PURE__ */ __name2((nodeId, side, edgeId) => {
  ...
  const faceIsClaimed = /* @__PURE__ */ __name2((nodeId, side, ignoreEdgeId) => {
...
__name2(simplifyDetouredEdges, "simplifyDetouredEdges");
var EPS5 = 1e-3;
...
__name2(markerClearanceRectFor, "markerClearanceRectFor");
...
__name2(normalizeRect, "normalizeRect");
...
__name2(labelOverlapsOwnMarker, "labelOverlapsOwnMarker");
function anchorLabelsToPolyline(edges, nodeByIdMap) {
  ...
  const labelOverlapsForeignNode = /* @__PURE__ */ __name2((labelId, rect) => {
  ...
  const labelOverlapsForeignEdge = /* @__PURE__ */ __name2((edgeId, rect) => {
    const buffered = inflateRect(rect, LABEL_PLACEMENT_BUFFER);
  ...
  const labelOverlapsAnything = /* @__PURE__ */ __name2((labelId, edgeId, rect) => labelOverlapsForeignNode(labelId, rect) || labelOverlapsForeignEdge(edgeId, rect), "labelOverlapsAnything");
  const placedLabelRects = [];
  const findContainingLane = /* @__PURE__ */ __name2((rect) => {
  ...
  const overlapsPlacedLabel = /* @__PURE__ */ __name2((labelId, rect) => placedLabelRects.some(
  ...
  for (const edge of edges) {
    ...
    const rankSegments = /* @__PURE__ */ __name2((pool) => {
    ...
    const anchorAtT = /* @__PURE__ */ __name2((seg, t) => {
      const a = pts[seg.idx];
    ...
    const clamp = /* @__PURE__ */ __name2((value, min, max) => Math.min(max, Math.max(min, value)), "clamp");
    const pointInsideRectInclusive = /* @__PURE__ */ __name2((point, rect) => point.midX >= rect.left - EPS5 && point.midX <= rect.right + EPS5 && point.midY >= rect.top - EPS5 && point.midY <= rect.bottom + EPS5, "pointInsideRectInclusive");
    const placementForAnchor = /* @__PURE__ */ __name2((anchor) => {
    ...
    const distanceAlongSegment = /* @__PURE__ */ __name2((seg, anchor, endpoint) => seg.orientation === "horizontal" ? Math.abs(anchor.midX - endpoint.x) : Math.abs(anchor.midY - endpoint.y), "distanceAlongSegment");
    const labelClearsTerminalEndpoints = /* @__PURE__ */ __name2((seg, anchor) => {
    ...
    const tryPool = /* @__PURE__ */ __name2((pool) => {
    ...
    const findLaneContainingFallback = /* @__PURE__ */ __name2((pool, requireEndpointClearance, allowForeignEdgeOverlap = false) => {
      const rankedPool = rankSegments(pool);
      for (const seg of rankedPool) {
...
__name2(anchorLabelsToPolyline, "anchorLabelsToPolyline");
var EPS6 = 1e-6;
...
function straightenCollinearSiblingDetours(edges, nodes) {
  ...
  const labelClearanceFor = /* @__PURE__ */ __name2((thisEdge, thisSrcId, thisDstId, axis) => {
    const targetPair = pairKey(thisSrcId, thisDstId);
    let maxHalf = 0;
    const consider = /* @__PURE__ */ __name2((labelId) => {
      if (!labelId) {
        return;
      }
...
__name2(straightenCollinearSiblingDetours, "straightenCollinearSiblingDetours");
function nudgeSharedInteriorSubpaths(edges, nodeByIdMap) {
  ...
  const segmentsFor2 = /* @__PURE__ */ __name2((edge, points) => {
  ...
  const allSegments = /* @__PURE__ */ __name2(() => {
    const result = [];
    for (const edge of edges) {
      if (edge.isLayoutOnly) {
        continue;
  ...
  const hasCrowdedParallelTrack = /* @__PURE__ */ __name2((a, b) => {
  ...
  const shiftedCandidate = /* @__PURE__ */ __name2((segment, shift) => {
  ...
  const nodeCenter = /* @__PURE__ */ __name2((node, rect) => ({
    x: node.x ?? (rect.left + rect.right) / 2,
    y: node.y ?? (rect.top + rect.bottom) / 2
  }), "nodeCenter");
  const sourceDetourContextFor = /* @__PURE__ */ __name2((segment) => {
  ...
  const verticalSourceDetour = /* @__PURE__ */ __name2((segment, shift, sourceCenter, targetCenter, sourceRect, tail) => {
  ...
  const horizontalSourceDetour = /* @__PURE__ */ __name2((segment, shift, sourceCenter, targetCenter, sourceRect, tail) => {
  ...
  const sourceDetourCandidate = /* @__PURE__ */ __name2((segment, shift) => {
...
__name2(nudgeSharedInteriorSubpaths, "nudgeSharedInteriorSubpaths");
...
__name2(segmentsIntersect, "segmentsIntersect");
...
__name2(validateSwimlanesLayout, "validateSwimlanesLayout");
function postProcessSwimlaneLayout(layout, direction) {
  ...
  const finalizeRenderedEdges = /* @__PURE__ */ __name2(() => {
...
__name2(postProcessSwimlaneLayout, "postProcessSwimlaneLayout");
...
__name2(buildSuccessorMap, "buildSuccessorMap");
...
__name2(buildSortedSuccessorMap, "buildSortedSuccessorMap");
...
__name2(buildInDegreeMap, "buildInDegreeMap");
...
__name2(sortedZeroInDegreeNodes, "sortedZeroInDegreeNodes");
...
__name2(buildPredecessorSuccessorMaps, "buildPredecessorSuccessorMaps");
...
__name2(buildLayersFromRanks, "buildLayersFromRanks");
...
__name2(topoSortIfAcyclic, "topoSortIfAcyclic");
...
__name2(buildLayerIndex, "buildLayerIndex");
function countInversions(values) {
  const tmp = new Array(values.length);
  const count = /* @__PURE__ */ __name2((left, right) => {
    if (right - left <= 1) {
      return 0;
    }
...
__name2(countInversions, "countInversions");
...
__name2(removeCycles_DFS, "removeCycles_DFS");
function buildTopLaneMap(g) {
  const cache = /* @__PURE__ */ new Map();
  const resolve = /* @__PURE__ */ __name2((id) => {
    if (cache.has(id)) {
      return cache.get(id);
    }
...
__name2(buildTopLaneMap, "buildTopLaneMap");
...
__name2(createTopLaneResolver, "createTopLaneResolver");
...
__name2(buildTopLaneOrder, "buildTopLaneOrder");
...
__name2(resolveTopLaneOrder, "resolveTopLaneOrder");
var PRECISION = {
...
function buildDrivingTree(graph, opts) {
  ...
  const postorder = [];
  const seen = /* @__PURE__ */ new Set();
  const walk = /* @__PURE__ */ __name2((node) => {
    if (seen.has(node)) {
      return;
    }
    seen.add(node);
...
__name2(buildDrivingTree, "buildDrivingTree");
...
__name2(chooseParent, "chooseParent");
...
__name2(buildAdjacency, "buildAdjacency");
...
__name2(assignComponents, "assignComponents");
function computeBlocks(adjacency) {
  ...
  const blocks = [];
  let time = 0;
  const visit = /* @__PURE__ */ __name2((node, parent) => {
...
__name2(computeBlocks, "computeBlocks");
...
function computeSubtreeCrossCounts(g, rankOf, tree) {
  ...
  const lcaIndex = /* @__PURE__ */ __name2((aIdx, bIdx) => {
    if (aIdx === -1 || bIdx === -1) {
      return -1;
    }
  ...
  const mergeInto = /* @__PURE__ */ __name2((target, source) => {
    if (source.size === 0) {
      return;
    }
  ...
  const dfs = /* @__PURE__ */ __name2((node) => {
    const idx = indexOf.get(node);
    visited.add(node);
...
__name2(computeSubtreeCrossCounts, "computeSubtreeCrossCounts");
function annotateMinimumLayers(nodes, children, rankOf) {
  const minLayer = /* @__PURE__ */ new Map();
  const annotate = /* @__PURE__ */ __name2((node) => {
...
__name2(annotateMinimumLayers, "annotateMinimumLayers");
...
__name2(compareByRankThenId, "compareByRankThenId");
function emitNodesInTreeOrder(roots, allNodes, rankOf, orderChildren) {
  ...
  const emit = /* @__PURE__ */ __name2((node) => {
    if (emitted.has(node)) {
      return;
    }
    emitted.add(node);
...
__name2(emitNodesInTreeOrder, "emitNodesInTreeOrder");
...
__name2(deduplicateLayers, "deduplicateLayers");
...
__name2(createChildOrderer, "createChildOrderer");
...
__name2(buildMultitreeLayerOrder, "buildMultitreeLayerOrder");
...
__name2(countCrossingsBetweenAdjacent, "countCrossingsBetweenAdjacent");
...
__name2(totalCrossings, "totalCrossings");
...
__name2(optimizeRanksByCrossings, "optimizeRanksByCrossings");
...
__name2(adjustCrossLaneSources, "adjustCrossLaneSources");
...
__name2(assignLayers_LongestPath, "assignLayers_LongestPath");
function assignLayers_Gravity(gAcyclic, opts) {
  ...
  const clampFeasible = /* @__PURE__ */ __name2((v, desired) => {
    let lb = 0;
    for (const u of preds.get(v) ?? []) {
      lb = Math.max(lb, (rankOf[u] ?? 0) + 1);
    }
  ...
  const relaxOrder = /* @__PURE__ */ __name2((nodeOrder) => {
    let changed = false;
...
__name2(assignLayers_Gravity, "assignLayers_Gravity");
...
__name2(topoSortByGenerationIfAcyclic, "topoSortByGenerationIfAcyclic");
function assignLayers_LaneAwareCompact(gAcyclic, opts) {
  ...
  const topLaneOf = createTopLaneResolver(g);
  const laneOf = /* @__PURE__ */ __name2((id) => topLaneOf(id) ?? id, "laneOf");
  const rankOf = /* @__PURE__ */ Object.create(null);
  const nextFree = /* @__PURE__ */ new Map();
  const edgeWeight = /* @__PURE__ */ __name2((u, v) => {
...
__name2(assignLayers_LaneAwareCompact, "assignLayers_LaneAwareCompact");
function makeProperLayering(layering, gAcyclic) {
  ...
  let dummySeq = 0;
  const nodeById = new Map(g.nodeById);
  const addDummyAt = /* @__PURE__ */ __name2((L) => {
...
__name2(makeProperLayering, "makeProperLayering");
...
__name2(neighborPositionsFor, "neighborPositionsFor");
...
__name2(currentOrderTieBreak, "currentOrderTieBreak");
...
__name(countCrossingsBetweenAdjacent2, "countCrossingsBetweenAdjacent2");
__name2(countCrossingsBetweenAdjacent2, "countCrossingsBetweenAdjacent");
...
__name2(sortByHeuristic, "sortByHeuristic");
...
__name2(reorderLayer, "reorderLayer");
function transposeImprove(upper, current, edges, next, topLaneOf) {
  ...
  const crossingScore = /* @__PURE__ */ __name2((order) => {
...
__name2(transposeImprove, "transposeImprove");
...
__name2(orderLayers, "orderLayers");
function assignCoordinates(ordered, gWithDummies, opts) {
  ...
  const getNode = /* @__PURE__ */ __name2((id) => gWithDummies.nodeById.get(id), "getNode");
  const getWidth = /* @__PURE__ */ __name2((id) => getNode(id)?.width ?? 0, "getWidth");
  const getHeight = /* @__PURE__ */ __name2((id) => getNode(id)?.height ?? 0, "getHeight");
  const topLaneOf = createTopLaneResolver(gWithDummies);
...
__name2(assignCoordinates, "assignCoordinates");
...
__name2(deterministicShuffle, "deterministicShuffle");
...
__name2(sourceDistance, "sourceDistance");
...
__name2(laneArrangementCost, "laneArrangementCost");
...
__name2(buildWeightedLaneEdges, "buildWeightedLaneEdges");
...
__name2(greedySwitch, "greedySwitch");
...
__name2(isBetterCandidate, "isBetterCandidate");
...
__name2(seedForRestart, "seedForRestart");
...
__name2(optimizeTopLaneOrder, "optimizeTopLaneOrder");
...
__name2(sugiyamaLayout, "sugiyamaLayout");
...
__name2(chooseOrthogonalSide, "chooseOrthogonalSide");
...
__name2(sharedLineEndpointCoord, "sharedLineEndpointCoord");
...
__name2(pointOnLine, "pointOnLine");
function routeEdgesOrthogonal(data, direction) {
  ...
  for (const group of topLevelGroups) {
    ...
    const assignLane = /* @__PURE__ */ __name2((n) => {
  ...
  const getOrAddPipe = /* @__PURE__ */ __name2((orientation, coord, spanMin, spanMax) => {
  ...
  const portForSide = /* @__PURE__ */ __name2((node, side) => {
  ...
  const getOrthogonalPort = /* @__PURE__ */ __name2((node, target, isSource) => portForSide(node, chooseOrthogonalSide(node, target, isSource ? "bottom" : "top")), "getOrthogonalPort");
  const allRoutedSegments = [];
  const edgeSegmentIndices = [];
  const straightIntraLaneEdges = /* @__PURE__ */ new Set();
  const CROSSING_PENALTY = 1e3;
  const crossingPenalty = /* @__PURE__ */ __name2((edgeIdx, from, to) => {
  ...
  const isSegmentBlocked = /* @__PURE__ */ __name2((p1, p2, excludeStart, excludeEnd) => {
  ...
  const determineSide = /* @__PURE__ */ __name2((node, target) => chooseOrthogonalSide(node, target, "bottom"), "determineSide");
  ...
  const preferenceStrength = /* @__PURE__ */ __name2((info) => {
  ...
  const secondarySide = /* @__PURE__ */ __name2((info) => {
    if (info.srcSide === "top" || info.srcSide === "bottom") {
  ...
  const loadKey = /* @__PURE__ */ __name2((nodeId, side) => `${nodeId}:${side}`, "loadKey");
  for (const info of sideInfoByIdx.values()) {
    sideLoad.set(
  ...
  const isDiamondNode = /* @__PURE__ */ __name2((node) => {
  ...
  const edgeHasLabelNode = /* @__PURE__ */ __name2((edgeIdx) => Boolean(edges[edgeIdx]?.labelNodeId), "edgeHasLabelNode");
  const faceHasLabelNode = /* @__PURE__ */ __name2((nodeId, side) => {
    if (!nodeId) {
      return false;
    }
  ...
  const applyPortOffset = /* @__PURE__ */ __name2((basePort, side, offset) => {
  ...
  const portsForEdge = /* @__PURE__ */ __name2((edgeIndex, src, dst) => {
  ...
  for (const i of routingOrder) {
    ...
    const isPointInObstacle = /* @__PURE__ */ __name2((pt, excludeNodeIds) => {
    ...
    const obstacleDetour = /* @__PURE__ */ __name2((port, node, opposite, obs, portIsVertical) => {
      if (portIsVertical) {
    ...
    const getKey = /* @__PURE__ */ __name2((x, y) => `${x.toFixed(1)},${y.toFixed(1)}`, "getKey");
    ...
    let foundPath = [];
    const checkSegmentBlocked = /* @__PURE__ */ __name2((p1, p2) => {
    ...
    if (foundPath.length > 4) {
      ...
      const findBestReturnY = /* @__PURE__ */ __name2((detourX) => {
      ...
      const trySimplifyWithDetourX = /* @__PURE__ */ __name2((detourX) => {
  ...
  const segmentsOverlap = /* @__PURE__ */ __name2((s1, s2) => {
    return s1.from < s2.to && s2.from < s1.to;
  }, "segmentsOverlap");
  const trySwapSegmentsAcrossTracks = /* @__PURE__ */ __name2((s1, s2, t1, t2) => {
  ...
  const createNewTrack = /* @__PURE__ */ __name2((pipe) => {
    const idx = pipe.tracks.length;
    pipe.tracks[idx] = { index: idx, coord: pipe.coord, segments: [] };
    return idx;
  }, "createNewTrack");
  const moveSegmentToTrack = /* @__PURE__ */ __name2((seg, trackIdx) => {
  ...
  const moveSegmentChainToTrack = /* @__PURE__ */ __name2((seg, trackIdx) => {
  ...
  const getAdjacentSegmentsAlongEdge = /* @__PURE__ */ __name2((seg) => {
    const indices = edgeSegmentIndices[seg.edgeIndex];
  ...
  const haveAnyCrossing = /* @__PURE__ */ __name2((segA, segB) => {
  ...
  const findAvailableTrack = /* @__PURE__ */ __name2((pipe, seg) => {
  ...
  const segmentsConflict = /* @__PURE__ */ __name2((s1, s2) => {
  ...
  const resolveTrackConflict = /* @__PURE__ */ __name2((s1, s2, move) => {
  ...
  const resolveHandleConflicts = /* @__PURE__ */ __name2((handles) => {
    let crossings = 0;
  ...
  const getDestInfo = /* @__PURE__ */ __name2((edgeIdx) => {
  ...
  const fixSourceHandleCrossings = /* @__PURE__ */ __name2(() => {
    let crossings = 0;
    ...
    const getEdgeDistance = /* @__PURE__ */ __name2((edgeIdx) => {
  ...
  const fixTargetHandleCrossings = /* @__PURE__ */ __name2(() => {
    let crossings = 0;
    ...
    for (const grp of edgesByTarget.values()) {
      grp.sort((a, b) => {
        const getDist = /* @__PURE__ */ __name2((edgeIdx) => {
          const indices = edgeSegmentIndices[edgeIdx];
          if (indices.length < 2) {
            return 0;
          }
  ...
  const fixPipeCrossings = /* @__PURE__ */ __name2(() => {
    let crossings = 0;
  ...
  for (const pipe of pipes) {
    ...
    for (const cluster of clusters) {
      ...
      const assignCoord = /* @__PURE__ */ __name2((trackIndex, coord) => {
  ...
  const nodeBoundaryClamp = /* @__PURE__ */ __name2((p, node) => {
    const cx = node.x ?? 0;
    const cy = node.y ?? 0;
...
__name2(runSwimlaneLayoutCore, "runSwimlaneLayoutCore");
...
__name2(prepareSwimlaneLayout, "prepareSwimlaneLayout");
