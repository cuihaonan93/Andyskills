import {
  getDiagramElement
} from "./chunk-BFXJ3EHU.mjs";
import {
  render
} from "./chunk-NXPVOQ4X.mjs";
import {
  setupViewPortForSVG
} from "./chunk-6SKQ5V72.mjs";
import {
  createTooltip
...
// ../mermaid/dist/chunks/mermaid.core/chunk-G27WJ6UU.mjs
var parser = (function() {
...
var getDir = /* @__PURE__ */ __name2((parsedItem, defaultDir = DEFAULT_NESTED_DOC_DIR) => {
  if (!parsedItem.doc) {
    return defaultDir;
  }
  let dir = defaultDir;
...
var getClasses = /* @__PURE__ */ __name2(function(text, diagramObj) {
  return diagramObj.db.getClasses();
}, "getClasses");
var draw = /* @__PURE__ */ __name2(async function(text, id, _version, diag) {
  log.info("REF0:");
...
var setupDoc = /* @__PURE__ */ __name2((parentParsedItem, doc, diagramStates, nodes, edges, altFlag, look, classes) => {
  log.trace("items", doc);
  doc.forEach((item) => {
    switch (item.stmt) {
      case STMT_STATE:
...
var getDir2 = /* @__PURE__ */ __name2((parsedItem, defaultDir = DEFAULT_NESTED_DOC_DIR) => {
  let dir = defaultDir;
  if (parsedItem.doc) {
    for (const parsedItemDoc of parsedItem.doc) {
      if (parsedItemDoc.stmt === "dir") {
...
var dataFetcher = /* @__PURE__ */ __name2((parent, parsedItem, diagramStates, nodes, edges, altFlag, look, classes) => {
...
var newClassesList = /* @__PURE__ */ __name2(() => /* @__PURE__ */ new Map(), "newClassesList");
var newDoc = /* @__PURE__ */ __name2(() => ({
  relations: [],
  states: /* @__PURE__ */ new Map(),
  documents: {}
}), "newDoc");
var clone = /* @__PURE__ */ __name2((o) => JSON.parse(JSON.stringify(o)), "clone");
var StateDB = class {
  static {
    __name(this, "StateDB");
  }
