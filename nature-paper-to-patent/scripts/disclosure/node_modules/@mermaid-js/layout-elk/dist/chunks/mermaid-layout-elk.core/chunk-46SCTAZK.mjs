...
// ../mermaid/dist/chunks/mermaid.core/chunk-R7TYR2AO.mjs
import {
  curveBasis,
  curveLinear,
  curveCardinal,
...
var computeLabelTransform = /* @__PURE__ */ __name2((bbox, useHtmlLabels) => {
  if (useHtmlLabels) {
...
var pointTransformer = /* @__PURE__ */ __name2((data) => {
  if (Array.isArray(data)) {
    return { x: data[0], y: data[1] };
  }
  return data;
}, "pointTransformer");
var getLineFunctionsWithOffset = /* @__PURE__ */ __name2((edge) => {
  return {
    x: /* @__PURE__ */ __name2(function(d, i, data) {
      let offset = 0;
    ...
    y: /* @__PURE__ */ __name2(function(d, i, data) {
      let offset = 0;
...
var addEdgeMarkers = /* @__PURE__ */ __name2((svgPath, edge, url, id, diagramType, useMargin = false, strokeColor) => {
...
var addEdgeMarker = /* @__PURE__ */ __name2((svgPath, position, arrowType, url, id, diagramType, useMargin = false, strokeColor) => {
...
var resolveEdgeCurveType = /* @__PURE__ */ __name2((edgeCurve) => {
...
var hasEdgeLabel = /* @__PURE__ */ __name2((edge) => Boolean(
  edge.label || edge.startLabelLeft || edge.startLabelRight || edge.endLabelLeft || edge.endLabelRight
), "hasEdgeLabel");
var getLabelStyles = /* @__PURE__ */ __name2((styleArray) => {
  if (!styleArray) {
    return "";
  }
...
var insertEdgeLabel = /* @__PURE__ */ __name2(async (elem, edge) => {
...
var positionEdgeLabel = /* @__PURE__ */ __name2((edge, paths) => {
...
var orthogonalizeToLabelClippedPoints = /* @__PURE__ */ __name2((edge, points) => {
...
var outsideNode = /* @__PURE__ */ __name2((node, point2) => {
  const x = node.x;
  const y = node.y;
...
var intersection = /* @__PURE__ */ __name2((node, outsidePoint, insidePoint) => {
...
var cutPathAtIntersect = /* @__PURE__ */ __name2((_points, boundaryNode) => {
...
var findAdjacentPoint = /* @__PURE__ */ __name2(function(pointA, pointB, distance) {
...
var fixCorners = /* @__PURE__ */ __name2(function(lineData) {
...
var generateDashArray = /* @__PURE__ */ __name2((len, oValueS, oValueE) => {
...
var insertEdge = /* @__PURE__ */ __name2(function(elem, edge, clusterDb, diagramType, startNode, endNode, diagramId, skipIntersect = false) {
  if (!diagramId) {
    throw new Error(
...
__name(calculateDeltaAndAngle2, "calculateDeltaAndAngle2");
__name2(calculateDeltaAndAngle2, "calculateDeltaAndAngle");
...
var insertMarkers = /* @__PURE__ */ __name2((elem, markerArray, type, id) => {
  markerArray.forEach((markerName) => {
    markers[markerName](elem, type, id);
  });
}, "insertMarkers");
var extension = /* @__PURE__ */ __name2((elem, type, id) => {
...
var composition = /* @__PURE__ */ __name2((elem, type, id) => {
...
var aggregation = /* @__PURE__ */ __name2((elem, type, id) => {
...
var dependency = /* @__PURE__ */ __name2((elem, type, id) => {
...
var lollipop = /* @__PURE__ */ __name2((elem, type, id) => {
...
var point = /* @__PURE__ */ __name2((elem, type, id) => {
...
var circle = /* @__PURE__ */ __name2((elem, type, id) => {
...
var cross = /* @__PURE__ */ __name2((elem, type, id) => {
...
var barb = /* @__PURE__ */ __name2((elem, type, id) => {
...
var barbNeo = /* @__PURE__ */ __name2((elem, type, id) => {
...
var only_one = /* @__PURE__ */ __name2((elem, type, id) => {
...
var zero_or_one = /* @__PURE__ */ __name2((elem, type, id) => {
...
var one_or_more = /* @__PURE__ */ __name2((elem, type, id) => {
...
var zero_or_more = /* @__PURE__ */ __name2((elem, type, id) => {
...
var only_one_neo = /* @__PURE__ */ __name2((elem, type, id) => {
  const config = getConfig();
  const { themeVariables } = config;
...
var zero_or_one_neo = /* @__PURE__ */ __name2((elem, type, id) => {
  const config = getConfig();
  const { themeVariables } = config;
...
var one_or_more_neo = /* @__PURE__ */ __name2((elem, type, id) => {
  const config = getConfig();
  const { themeVariables } = config;
  const { strokeWidth } = themeVariables;
...
var zero_or_more_neo = /* @__PURE__ */ __name2((elem, type, id) => {
  const config = getConfig();
  const { themeVariables } = config;
  const { strokeWidth, mainBkg } = themeVariables;
...
var requirement_arrow = /* @__PURE__ */ __name2((elem, type, id) => {
...
var requirement_arrow_neo = /* @__PURE__ */ __name2((elem, type, id) => {
  const config = getConfig();
  const { themeVariables } = config;
  const { strokeWidth } = themeVariables;
...
var requirement_contains = /* @__PURE__ */ __name2((elem, type, id) => {
...
var requirement_contains_neo = /* @__PURE__ */ __name2((elem, type, id) => {
  const config = getConfig();
  const { themeVariables } = config;
  const { strokeWidth } = themeVariables;
