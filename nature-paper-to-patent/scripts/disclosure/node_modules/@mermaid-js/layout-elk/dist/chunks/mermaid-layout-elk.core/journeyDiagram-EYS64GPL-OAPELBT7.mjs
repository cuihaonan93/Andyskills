...
// ../mermaid/dist/chunks/mermaid.core/journeyDiagram-EYS64GPL.mjs
...
var updateActors = /* @__PURE__ */ __name2(function() {
  const tempActors = [];
  tasks.forEach((task) => {
    if (task.people) {
...
var addTask = /* @__PURE__ */ __name2(function(descr, taskData) {
...
var getActors = /* @__PURE__ */ __name2(function() {
  return updateActors();
}, "getActors");
var journeyDb_default = {
  getConfig: /* @__PURE__ */ __name2(() => getConfig2().journey, "getConfig"),
  clear: clear2,
  setDiagramTitle,
  getDiagramTitle,
  setAccTitle,
...
var getStyles = /* @__PURE__ */ __name2((options) => `.label {
...
var drawText2 = /* @__PURE__ */ __name2(function(elem, textData) {
...
var drawSection = /* @__PURE__ */ __name2(function(elem, section, conf2) {
...
var taskCount = -1;
var drawTask = /* @__PURE__ */ __name2(function(elem, task, conf2, diagramId) {
...
var drawTasks = /* @__PURE__ */ __name2(function(diagram2, tasks2, verticalPos, diagramId) {
  const conf2 = getConfig2().journey;
  let lastSection = "";
