...
// ../mermaid/dist/chunks/mermaid.core/chunk-LCL6LL3I.mjs
var parser = (function() {
...
var classCounter = 0;
var sanitizeText2 = /* @__PURE__ */ __name2((txt) => common_default.sanitizeText(txt, getConfig2()), "sanitizeText");
var ClassDB = class _ClassDB {
  static {
    __name(this, "_ClassDB");
  }
  constructor() {
    this.relations = [];
    ...
    this.setupToolTips = /* @__PURE__ */ __name2((element) => {
    ...
    this.getConfig = /* @__PURE__ */ __name2(() => getConfig2().class, "getConfig");
...
var getStyles = /* @__PURE__ */ __name2((options) => `g.classGroup text {
...
var getDir = /* @__PURE__ */ __name2((parsedItem, defaultDir = "TB") => {
  if (!parsedItem.doc) {
    return defaultDir;
  }
  let dir = defaultDir;
