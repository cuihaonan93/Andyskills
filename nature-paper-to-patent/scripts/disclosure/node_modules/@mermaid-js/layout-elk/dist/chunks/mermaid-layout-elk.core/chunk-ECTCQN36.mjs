...
var require_fastdom_promised = __commonJS({
  "../../node_modules/.pnpm/fastdom@1.0.12/node_modules/fastdom/extensions/fastdom-promised.js"(exports, module) {
    "use strict";
    !(function() {
      var exports2 = {
...
// ../mermaid/dist/chunks/mermaid.core/chunk-GMAD6QVW.mjs
...
var now = /* @__PURE__ */ __name2(() => hasPerformance ? performance.now() : 0, "now");
...
var Profiler = class {
  ...
  printSummary(root = this.report(), label) {
    ...
    const walk = /* @__PURE__ */ __name2((span, depth) => {
...
__name2(nonMarkdownToLines, "nonMarkdownToLines");
...
__name2(nonMarkdownToHTML, "nonMarkdownToHTML");
...
function createFormattedText(width, g, structuredText, addBackground = false, centerText = false) {
  ...
  for (const line of structuredText) {
    const checkWidth = /* @__PURE__ */ __name2((line2) => computeWidthOfText(labelGroup, lineHeight, line2) <= width, "checkWidth");
...
var createText = /* @__PURE__ */ __name2(async (el, text = "", {
  style = "",
  isTitle = false,
  classes = "",
  useHtmlLabels = true,
