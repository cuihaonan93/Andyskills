...
// ../mermaid/dist/chunks/mermaid.core/mindmap-definition-FBJOCRG2.mjs
var parser = (function() {
...
var MindmapDB = class {
  ...
  flattenNodes(node, processedNodes) {
    ...
    const getShapeFromType = /* @__PURE__ */ __name2((type) => {
...
var genGradient = /* @__PURE__ */ __name2((THEME_COLOR_LIMIT, svgId, mainBkg) => {
  let sections = "";
